...
module Fractal.Object.DeleteReactionPayload exposing (..)
...
reaction :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.DeleteReactionPayload
...
msg : SelectionSet (Maybe String) Fractal.Object.DeleteReactionPayload
msg =
    Object.selectionForField "(Maybe String)" "msg" [] (Decode.string |> Decode.nullable)


numUids : SelectionSet (Maybe Int) Fractal.Object.DeleteReactionPayload
numUids =
