...
module Fractal.Object.PostAggregateResult exposing (..)
...
count : SelectionSet (Maybe Int) Fractal.Object.PostAggregateResult
count =
    Object.selectionForField "(Maybe Int)" "count" [] (Decode.int |> Decode.nullable)


createdAtMin : SelectionSet (Maybe Fractal.ScalarCodecs.DateTime) Fractal.Object.PostAggregateResult
createdAtMin =
...
createdAtMax : SelectionSet (Maybe Fractal.ScalarCodecs.DateTime) Fractal.Object.PostAggregateResult
createdAtMax =
...
updatedAtMin : SelectionSet (Maybe Fractal.ScalarCodecs.DateTime) Fractal.Object.PostAggregateResult
updatedAtMin =
...
updatedAtMax : SelectionSet (Maybe Fractal.ScalarCodecs.DateTime) Fractal.Object.PostAggregateResult
updatedAtMax =
...
messageMin : SelectionSet (Maybe String) Fractal.Object.PostAggregateResult
messageMin =
    Object.selectionForField "(Maybe String)" "messageMin" [] (Decode.string |> Decode.nullable)


messageMax : SelectionSet (Maybe String) Fractal.Object.PostAggregateResult
messageMax =
