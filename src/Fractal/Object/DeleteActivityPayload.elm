...
module Fractal.Object.DeleteActivityPayload exposing (..)
...
activity :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.DeleteActivityPayload
...
msg : SelectionSet (Maybe String) Fractal.Object.DeleteActivityPayload
msg =
    Object.selectionForField "(Maybe String)" "msg" [] (Decode.string |> Decode.nullable)


numUids : SelectionSet (Maybe Int) Fractal.Object.DeleteActivityPayload
numUids =
