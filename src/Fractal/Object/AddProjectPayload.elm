...
module Fractal.Object.AddProjectPayload exposing (..)
...
project :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.AddProjectPayload
...
numUids : SelectionSet (Maybe Int) Fractal.Object.AddProjectPayload
numUids =
