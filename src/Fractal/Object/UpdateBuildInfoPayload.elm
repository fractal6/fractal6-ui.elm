...
module Fractal.Object.UpdateBuildInfoPayload exposing (..)
...
buildInfo :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.UpdateBuildInfoPayload
...
numUids : SelectionSet (Maybe Int) Fractal.Object.UpdateBuildInfoPayload
numUids =
