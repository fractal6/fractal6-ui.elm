...
module Fractal.Object.AddActivityPayload exposing (..)
...
activity :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.AddActivityPayload
...
numUids : SelectionSet (Maybe Int) Fractal.Object.AddActivityPayload
numUids =
