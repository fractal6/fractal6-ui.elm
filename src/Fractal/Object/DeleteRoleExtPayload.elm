...
module Fractal.Object.DeleteRoleExtPayload exposing (..)
...
roleExt :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.DeleteRoleExtPayload
...
msg : SelectionSet (Maybe String) Fractal.Object.DeleteRoleExtPayload
msg =
    Object.selectionForField "(Maybe String)" "msg" [] (Decode.string |> Decode.nullable)


numUids : SelectionSet (Maybe Int) Fractal.Object.DeleteRoleExtPayload
numUids =
