...
label : (LabelOptionalArguments -> LabelOptionalArguments) -> SelectionSet decodesTo Fractal.Object.Label -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.AddLabelPayload
