...
module Fractal.Object.AddLabelPayload exposing (..)
...
label :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.AddLabelPayload
...
numUids : SelectionSet (Maybe Int) Fractal.Object.AddLabelPayload
numUids =
