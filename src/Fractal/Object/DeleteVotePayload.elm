...
module Fractal.Object.DeleteVotePayload exposing (..)
...
vote :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.DeleteVotePayload
...
msg : SelectionSet (Maybe String) Fractal.Object.DeleteVotePayload
msg =
    Object.selectionForField "(Maybe String)" "msg" [] (Decode.string |> Decode.nullable)


numUids : SelectionSet (Maybe Int) Fractal.Object.DeleteVotePayload
numUids =
