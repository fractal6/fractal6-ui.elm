...
module Fractal.Object.DeleteNotifPayload exposing (..)
...
notif :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.DeleteNotifPayload
...
msg : SelectionSet (Maybe String) Fractal.Object.DeleteNotifPayload
msg =
    Object.selectionForField "(Maybe String)" "msg" [] (Decode.string |> Decode.nullable)


numUids : SelectionSet (Maybe Int) Fractal.Object.DeleteNotifPayload
numUids =
