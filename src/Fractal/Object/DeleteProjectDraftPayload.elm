...
module Fractal.Object.DeleteProjectDraftPayload exposing (..)
...
projectDraft :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.DeleteProjectDraftPayload
...
msg : SelectionSet (Maybe String) Fractal.Object.DeleteProjectDraftPayload
msg =
    Object.selectionForField "(Maybe String)" "msg" [] (Decode.string |> Decode.nullable)


numUids : SelectionSet (Maybe Int) Fractal.Object.DeleteProjectDraftPayload
numUids =
