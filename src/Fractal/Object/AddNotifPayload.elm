...
module Fractal.Object.AddNotifPayload exposing (..)
...
notif :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.AddNotifPayload
...
numUids : SelectionSet (Maybe Int) Fractal.Object.AddNotifPayload
numUids =
