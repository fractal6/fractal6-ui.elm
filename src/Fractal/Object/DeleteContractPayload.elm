...
module Fractal.Object.DeleteContractPayload exposing (..)
...
contract :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.DeleteContractPayload
...
msg : SelectionSet (Maybe String) Fractal.Object.DeleteContractPayload
msg =
    Object.selectionForField "(Maybe String)" "msg" [] (Decode.string |> Decode.nullable)


numUids : SelectionSet (Maybe Int) Fractal.Object.DeleteContractPayload
numUids =
