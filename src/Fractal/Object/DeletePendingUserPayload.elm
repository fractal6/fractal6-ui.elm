...
module Fractal.Object.DeletePendingUserPayload exposing (..)
...
pendingUser :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.DeletePendingUserPayload
...
msg : SelectionSet (Maybe String) Fractal.Object.DeletePendingUserPayload
msg =
    Object.selectionForField "(Maybe String)" "msg" [] (Decode.string |> Decode.nullable)


numUids : SelectionSet (Maybe Int) Fractal.Object.DeletePendingUserPayload
numUids =
