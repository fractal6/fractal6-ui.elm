...
module Fractal.Object.DeleteTensionPayload exposing (..)
...
tension :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.DeleteTensionPayload
tension fillInOptionals____ object____ =
    ...
    in
    Object.selectionForCompositeField "tension" optionalArgs____ object____ (Basics.identity >> Decode.nullable >> Decode.list >> Decode.nullable)


msg : SelectionSet (Maybe String) Fractal.Object.DeleteTensionPayload
msg =
    Object.selectionForField "(Maybe String)" "msg" [] (Decode.string |> Decode.nullable)


numUids : SelectionSet (Maybe Int) Fractal.Object.DeleteTensionPayload
numUids =
