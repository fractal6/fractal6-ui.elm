...
module Fractal.Object.UpdateRoleExtPayload exposing (..)
...
roleExt :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Fractal.Object.UpdateRoleExtPayload
...
numUids : SelectionSet (Maybe Int) Fractal.Object.UpdateRoleExtPayload
numUids =
