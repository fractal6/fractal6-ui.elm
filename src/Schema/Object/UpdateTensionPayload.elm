...
module Schema.Object.UpdateTensionPayload exposing (..)
...
tension :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Schema.Object.UpdateTensionPayload
...
numUids : SelectionSet (Maybe Int) Schema.Object.UpdateTensionPayload
numUids =
