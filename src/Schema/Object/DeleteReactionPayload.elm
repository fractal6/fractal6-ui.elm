...
module Schema.Object.DeleteReactionPayload exposing (..)
...
reaction :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Schema.Object.DeleteReactionPayload
...
msg : SelectionSet (Maybe String) Schema.Object.DeleteReactionPayload
msg =
    Object.selectionForField "(Maybe String)" "msg" [] (Decode.string |> Decode.nullable)


numUids : SelectionSet (Maybe Int) Schema.Object.DeleteReactionPayload
numUids =
