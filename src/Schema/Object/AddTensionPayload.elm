...
module Schema.Object.AddTensionPayload exposing (..)
...
tension :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Schema.Object.AddTensionPayload
...
numUids : SelectionSet (Maybe Int) Schema.Object.AddTensionPayload
numUids =
