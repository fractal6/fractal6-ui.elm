...
module Schema.Object.DeleteFilePayload exposing (..)
...
file :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Schema.Object.DeleteFilePayload
...
msg : SelectionSet (Maybe String) Schema.Object.DeleteFilePayload
msg =
    Object.selectionForField "(Maybe String)" "msg" [] (Decode.string |> Decode.nullable)


numUids : SelectionSet (Maybe Int) Schema.Object.DeleteFilePayload
numUids =
