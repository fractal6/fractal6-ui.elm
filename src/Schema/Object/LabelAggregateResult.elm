...
module Schema.Object.LabelAggregateResult exposing (..)
...
count : SelectionSet (Maybe Int) Schema.Object.LabelAggregateResult
count =
    Object.selectionForField "(Maybe Int)" "count" [] (Decode.int |> Decode.nullable)


rootnameidMin : SelectionSet (Maybe String) Schema.Object.LabelAggregateResult
rootnameidMin =
    Object.selectionForField "(Maybe String)" "rootnameidMin" [] (Decode.string |> Decode.nullable)


rootnameidMax : SelectionSet (Maybe String) Schema.Object.LabelAggregateResult
rootnameidMax =
    Object.selectionForField "(Maybe String)" "rootnameidMax" [] (Decode.string |> Decode.nullable)


nameMin : SelectionSet (Maybe String) Schema.Object.LabelAggregateResult
nameMin =
    Object.selectionForField "(Maybe String)" "nameMin" [] (Decode.string |> Decode.nullable)


nameMax : SelectionSet (Maybe String) Schema.Object.LabelAggregateResult
nameMax =
    Object.selectionForField "(Maybe String)" "nameMax" [] (Decode.string |> Decode.nullable)


descriptionMin : SelectionSet (Maybe String) Schema.Object.LabelAggregateResult
descriptionMin =
    Object.selectionForField "(Maybe String)" "descriptionMin" [] (Decode.string |> Decode.nullable)


descriptionMax : SelectionSet (Maybe String) Schema.Object.LabelAggregateResult
descriptionMax =
    Object.selectionForField "(Maybe String)" "descriptionMax" [] (Decode.string |> Decode.nullable)


colorMin : SelectionSet (Maybe String) Schema.Object.LabelAggregateResult
colorMin =
    Object.selectionForField "(Maybe String)" "colorMin" [] (Decode.string |> Decode.nullable)


colorMax : SelectionSet (Maybe String) Schema.Object.LabelAggregateResult
colorMax =
