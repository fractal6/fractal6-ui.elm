...
module Schema.Object.DeleteTensionPayload exposing (..)
...
tension :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Schema.Object.DeleteTensionPayload
...
msg : SelectionSet (Maybe String) Schema.Object.DeleteTensionPayload
msg =
    Object.selectionForField "(Maybe String)" "msg" [] (Decode.string |> Decode.nullable)


numUids : SelectionSet (Maybe Int) Schema.Object.DeleteTensionPayload
numUids =
