...
module Schema.Object.AddReactionPayload exposing (..)
...
reaction :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Schema.Object.AddReactionPayload
...
numUids : SelectionSet (Maybe Int) Schema.Object.AddReactionPayload
numUids =
