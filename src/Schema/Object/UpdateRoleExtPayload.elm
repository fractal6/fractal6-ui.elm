...
module Schema.Object.UpdateRoleExtPayload exposing (..)
...
roleExt :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Schema.Object.UpdateRoleExtPayload
...
numUids : SelectionSet (Maybe Int) Schema.Object.UpdateRoleExtPayload
numUids =
