...
module Schema.Object.UpdateFilePayload exposing (..)
...
file :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Schema.Object.UpdateFilePayload
...
numUids : SelectionSet (Maybe Int) Schema.Object.UpdateFilePayload
numUids =
