...
module Schema.Object.AddRoleExtPayload exposing (..)
...
roleExt :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Schema.Object.AddRoleExtPayload
...
numUids : SelectionSet (Maybe Int) Schema.Object.AddRoleExtPayload
numUids =
