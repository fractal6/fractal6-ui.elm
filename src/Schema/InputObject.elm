...
module Schema.InputObject exposing (..)
...
import Schema.Enum.ActivityHasFilter
import Schema.Enum.ActivityOrderable
import Schema.Enum.BlobHasFilter
import Schema.Enum.BlobOrderable
import Schema.Enum.BuildInfoHasFilter
import Schema.Enum.BuildInfoOrderable
import Schema.Enum.CardKindType
import Schema.Enum.CommentHasFilter
import Schema.Enum.CommentOrderable
import Schema.Enum.ContractHasFilter
import Schema.Enum.ContractOrderable
import Schema.Enum.ContractStatus
import Schema.Enum.ContractType
import Schema.Enum.EventCountHasFilter
import Schema.Enum.EventCountOrderable
import Schema.Enum.EventFragmentHasFilter
import Schema.Enum.EventFragmentOrderable
import Schema.Enum.EventHasFilter
import Schema.Enum.EventKindType
import Schema.Enum.EventOrderable
import Schema.Enum.FileHasFilter
import Schema.Enum.FileOrderable
import Schema.Enum.HTTPMethod
import Schema.Enum.LabelHasFilter
import Schema.Enum.LabelOrderable
import Schema.Enum.Lang
import Schema.Enum.MandateHasFilter
import Schema.Enum.MandateOrderable
import Schema.Enum.Mode
import Schema.Enum.NodeFragmentHasFilter
import Schema.Enum.NodeFragmentOrderable
import Schema.Enum.NodeHasFilter
import Schema.Enum.NodeMode
import Schema.Enum.NodeOrderable
import Schema.Enum.NodeType
import Schema.Enum.NodeVisibility
import Schema.Enum.NotifHasFilter
import Schema.Enum.NotifOrderable
import Schema.Enum.PendingUserHasFilter
import Schema.Enum.PendingUserOrderable
import Schema.Enum.PostHasFilter
import Schema.Enum.PostOrderable
import Schema.Enum.ProjectCardHasFilter
import Schema.Enum.ProjectCardOrderable
import Schema.Enum.ProjectColumnHasFilter
import Schema.Enum.ProjectColumnOrderable
import Schema.Enum.ProjectColumnType
import Schema.Enum.ProjectDraftHasFilter
import Schema.Enum.ProjectDraftOrderable
import Schema.Enum.ProjectFieldHasFilter
import Schema.Enum.ProjectFieldType
import Schema.Enum.ProjectFieldValueHasFilter
import Schema.Enum.ProjectFieldValueOrderable
...
import Schema.Enum.TensionTemplateHasFilter
import Schema.Enum.TensionTemplateOrderable
import Schema.Enum.TensionType
import Schema.Enum.UserEventHasFilter
import Schema.Enum.UserEventOrderable
import Schema.Enum.UserHasFilter
import Schema.Enum.UserOrderable
import Schema.Enum.UserRightsHasFilter
import Schema.Enum.UserRightsOrderable
import Schema.Enum.UserType
import Schema.Enum.VoteHasFilter
import Schema.Enum.VoteOrderable
...
buildActivityFilter :
    (ActivityFilterOptionalFields -> ActivityFilterOptionalFields)
    -> ActivityFilter
buildActivityFilter fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { id = Absent, activityid = Absent, ownerid = Absent, date = Absent, has = Absent, and = Absent, or = Absent, not = Absent }
    in
    ActivityFilter { id = optionals____.id, activityid = optionals____.activityid, ownerid = optionals____.ownerid, date = optionals____.date, has = optionals____.has, and = optionals____.and, or = optionals____.or, not = optionals____.not }


type alias ActivityFilterOptionalFields =
    { id : OptionalArgument (List Schema.ScalarCodecs.Id)
    , activityid : OptionalArgument StringHashFilter
    , ownerid : OptionalArgument StringHashFilter
    , date : OptionalArgument DateTimeFilter
    , has : OptionalArgument (List (Maybe Schema.Enum.ActivityHasFilter.ActivityHasFilter))
    , and : OptionalArgument (List (Maybe ActivityFilter))
    , or : OptionalArgument (List (Maybe ActivityFilter))
    , not : OptionalArgument ActivityFilter
    }


{-| Type alias for the `ActivityFilter` attributes. Note that this type
needs to use the `ActivityFilter` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/elm-graphql/issues/33>.
-}
type alias ActivityFilterRaw =
    { id : OptionalArgument (List Schema.ScalarCodecs.Id)
    , activityid : OptionalArgument StringHashFilter
    , ownerid : OptionalArgument StringHashFilter
    , date : OptionalArgument DateTimeFilter
...
{-| Type for the ActivityFilter input object.
-}
type ActivityFilter
    = ActivityFilter ActivityFilterRaw


{-| Encode a ActivityFilter into a value that can be used as an argument.
-}
encodeActivityFilter : ActivityFilter -> Value
encodeActivityFilter (ActivityFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "activityid", encodeStringHashFilter |> Encode.optional input____.activityid ), ( "ownerid", encodeStringHashFilter |> Encode.optional input____.ownerid ), ( "date", encodeDateTimeFilter |> Encode.optional input____.date ), ( "has", (Encode.enum Schema.Enum.ActivityHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeActivityFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeActivityFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeActivityFilter |> Encode.optional input____.not ) ]


buildActivityOrder :
    (ActivityOrderOptionalFields -> ActivityOrderOptionalFields)
    -> ActivityOrder
buildActivityOrder fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { asc = Absent, desc = Absent, then_ = Absent }
    in
    ActivityOrder { asc = optionals____.asc, desc = optionals____.desc, then_ = optionals____.then_ }


type alias ActivityOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.ActivityOrderable.ActivityOrderable
    , desc : OptionalArgument Schema.Enum.ActivityOrderable.ActivityOrderable
    , then_ : OptionalArgument ActivityOrder
    }


{-| Type alias for the `ActivityOrder` attributes. Note that this type
needs to use the `ActivityOrder` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/elm-graphql/issues/33>.
-}
type alias ActivityOrderRaw =
    { asc : OptionalArgument Schema.Enum.ActivityOrderable.ActivityOrderable
    , desc : OptionalArgument Schema.Enum.ActivityOrderable.ActivityOrderable
    , then_ : OptionalArgument ActivityOrder
    }
...
{-| Type for the ActivityOrder input object.
-}
type ActivityOrder
    = ActivityOrder ActivityOrderRaw


{-| Encode a ActivityOrder into a value that can be used as an argument.
-}
encodeActivityOrder : ActivityOrder -> Value
encodeActivityOrder (ActivityOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.ActivityOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.ActivityOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeActivityOrder |> Encode.optional input____.then_ ) ]


buildActivityPatch :
    (ActivityPatchOptionalFields -> ActivityPatchOptionalFields)
    -> ActivityPatch
buildActivityPatch fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { ownerid = Absent, date = Absent, count = Absent }
    in
    { ownerid = optionals____.ownerid, date = optionals____.date, count = optionals____.count }


type alias ActivityPatchOptionalFields =
    { ownerid : OptionalArgument String
    , date : OptionalArgument Schema.ScalarCodecs.DateTime
    , count : OptionalArgument Int
    }


{-| Type for the ActivityPatch input object.
-}
type alias ActivityPatch =
    { ownerid : OptionalArgument String
    , date : OptionalArgument Schema.ScalarCodecs.DateTime
    , count : OptionalArgument Int
    }
...
{-| Encode a ActivityPatch into a value that can be used as an argument.
-}
encodeActivityPatch : ActivityPatch -> Value
encodeActivityPatch input____ =
    Encode.maybeObject
        [ ( "ownerid", Encode.string |> Encode.optional input____.ownerid ), ( "date", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.date ), ( "count", Encode.int |> Encode.optional input____.count ) ]


buildActivityRef :
    (ActivityRefOptionalFields -> ActivityRefOptionalFields)
    -> ActivityRef
buildActivityRef fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { id = Absent, activityid = Absent, ownerid = Absent, date = Absent, count = Absent }
    in
    { id = optionals____.id, activityid = optionals____.activityid, ownerid = optionals____.ownerid, date = optionals____.date, count = optionals____.count }


type alias ActivityRefOptionalFields =
...
{-| Type for the ActivityRef input object.
-}
type alias ActivityRef =
    { id : OptionalArgument Schema.ScalarCodecs.Id
    , activityid : OptionalArgument String
    , ownerid : OptionalArgument String
    , date : OptionalArgument Schema.ScalarCodecs.DateTime
...
{-| Encode a ActivityRef into a value that can be used as an argument.
-}
encodeActivityRef : ActivityRef -> Value
encodeActivityRef input____ =
    Encode.maybeObject
        [ ( "id", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.id ), ( "activityid", Encode.string |> Encode.optional input____.activityid ), ( "ownerid", Encode.string |> Encode.optional input____.ownerid ), ( "date", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.date ), ( "count", Encode.int |> Encode.optional input____.count ) ]


buildAddActivityInput :
    AddActivityInputRequiredFields
    -> AddActivityInput
buildAddActivityInput required____ =
    { activityid = required____.activityid, ownerid = required____.ownerid, date = required____.date, count = required____.count }


type alias AddActivityInputRequiredFields =
    { activityid : String
    , ownerid : String
    , date : Schema.ScalarCodecs.DateTime
    , count : Int
    }


{-| Type for the AddActivityInput input object.
-}
type alias AddActivityInput =
    { activityid : String
    , ownerid : String
    , date : Schema.ScalarCodecs.DateTime
    , count : Int
...
{-| Encode a AddActivityInput into a value that can be used as an argument.
-}
encodeAddActivityInput : AddActivityInput -> Value
encodeAddActivityInput input____ =
    Encode.maybeObject
        [ ( "activityid", Encode.string input____.activityid |> Just ), ( "ownerid", Encode.string input____.ownerid |> Just ), ( "date", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) input____.date |> Just ), ( "count", Encode.int input____.count |> Just ) ]
...
buildAddBlobInput required____ fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { updatedAt = Absent, message = Absent, pushedFlag = Absent, node = Absent }
    in
    AddBlobInput { createdBy = required____.createdBy, createdAt = required____.createdAt, updatedAt = optionals____.updatedAt, message = optionals____.message, tension = required____.tension, pushedFlag = optionals____.pushedFlag, node = optionals____.node }


type alias AddBlobInputRequiredFields =
    { createdBy : UserRef
    , createdAt : Schema.ScalarCodecs.DateTime
    , tension : TensionRef
    }
...
type alias AddBlobInputOptionalFields =
    ...
    , pushedFlag : OptionalArgument Schema.ScalarCodecs.DateTime
...
type alias AddContractInputRequiredFields =
    ...
    , contractid : String
    , tension : TensionRef
    , status : Schema.Enum.ContractStatus.ContractStatus
    , contract_type : Schema.Enum.ContractType.ContractType
...
type alias AddContractInputOptionalFields =
    { updatedAt : OptionalArgument Schema.ScalarCodecs.DateTime
    , message : OptionalArgument String
    , closedAt : OptionalArgument Schema.ScalarCodecs.DateTime
...
encodeAddContractInput (AddContractInput input____) =
    Encode.maybeObject
        [ ( "createdBy", encodeUserRef input____.createdBy |> Just ), ( "createdAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) input____.createdAt |> Just ), ( "updatedAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.updatedAt ), ( "message", Encode.string |> Encode.optional input____.message ), ( "contractid", Encode.string input____.contractid |> Just ), ( "tension", encodeTensionRef input____.tension |> Just ), ( "status", Encode.enum Schema.Enum.ContractStatus.toString input____.status |> Just ), ( "contract_type", Encode.enum Schema.Enum.ContractType.toString input____.contract_type |> Just ), ( "closedAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.closedAt ), ( "event", encodeEventFragmentRef input____.event |> Just ), ( "participants", (encodeVoteRef |> Encode.list) input____.participants |> Just ), ( "candidates", (encodeUserRef |> Encode.list) |> Encode.optional input____.candidates ), ( "pending_candidates", (encodePendingUserRef |> Encode.list) |> Encode.optional input____.pending_candidates ), ( "comments", (encodeCommentRef |> Encode.list) |> Encode.optional input____.comments ), ( "isValidator", Encode.bool |> Encode.optional input____.isValidator ) ]
...
type alias AddEventFragmentInputRequiredFields =
    { event_type : Schema.Enum.TensionEvent.TensionEvent }
...
encodeAddEventFragmentInput input____ =
    Encode.maybeObject
        [ ( "event_type", Encode.enum Schema.Enum.TensionEvent.toString input____.event_type |> Just ), ( "old", Encode.string |> Encode.optional input____.old ), ( "new", Encode.string |> Encode.optional input____.new ) ]
...
encodeAddEventInput (AddEventInput input____) =
    Encode.maybeObject
        [ ( "createdBy", encodeUserRef input____.createdBy |> Just ), ( "createdAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) input____.createdAt |> Just ), ( "updatedAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.updatedAt ), ( "message", Encode.string |> Encode.optional input____.message ), ( "tension", encodeTensionRef input____.tension |> Just ), ( "event_type", Encode.enum Schema.Enum.TensionEvent.toString input____.event_type |> Just ), ( "mentioned", encodeTensionRef |> Encode.optional input____.mentioned ), ( "old", Encode.string |> Encode.optional input____.old ), ( "new", Encode.string |> Encode.optional input____.new ) ]


buildAddFileInput :
    AddFileInputRequiredFields
    -> (AddFileInputOptionalFields -> AddFileInputOptionalFields)
    -> AddFileInput
buildAddFileInput required____ fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { comment = Absent, tension = Absent, user = Absent, node = Absent, embedded = Absent }
    in
    AddFileInput { createdBy = required____.createdBy, createdAt = required____.createdAt, filename = required____.filename, contentType = required____.contentType, size = required____.size, storageKey = required____.storageKey, comment = optionals____.comment, tension = optionals____.tension, user = optionals____.user, node = optionals____.node, embedded = optionals____.embedded }


type alias AddFileInputRequiredFields =
    { createdBy : UserRef
    , createdAt : Schema.ScalarCodecs.DateTime
    , filename : String
    , contentType : String
...
type alias AddFileInputOptionalFields =
    ...
    , embedded : OptionalArgument Bool
    }


{-| Type alias for the `AddFileInput` attributes. Note that this type
needs to use the `AddFileInput` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/elm-graphql/issues/33>.
-}
type alias AddFileInputRaw =
    { createdBy : UserRef
    , createdAt : Schema.ScalarCodecs.DateTime
    , filename : String
    , contentType : String
...
{-| Type for the AddFileInput input object.
-}
type AddFileInput
    = AddFileInput AddFileInputRaw


{-| Encode a AddFileInput into a value that can be used as an argument.
-}
encodeAddFileInput : AddFileInput -> Value
encodeAddFileInput (AddFileInput input____) =
    Encode.maybeObject
        [ ( "createdBy", encodeUserRef input____.createdBy |> Just ), ( "createdAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) input____.createdAt |> Just ), ( "filename", Encode.string input____.filename |> Just ), ( "contentType", Encode.string input____.contentType |> Just ), ( "size", Encode.int input____.size |> Just ), ( "storageKey", Encode.string input____.storageKey |> Just ), ( "comment", encodeCommentRef |> Encode.optional input____.comment ), ( "tension", encodeTensionRef |> Encode.optional input____.tension ), ( "user", encodeUserRef |> Encode.optional input____.user ), ( "node", encodeNodeRef |> Encode.optional input____.node ), ( "embedded", Encode.bool |> Encode.optional input____.embedded ) ]
...
buildAddLabelInput required____ fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { nodes = Absent, description = Absent, color = Absent, tensions = Absent }
    in
    AddLabelInput { rootnameid = required____.rootnameid, name = required____.name, nodes = optionals____.nodes, description = optionals____.description, color = optionals____.color, tensions = optionals____.tensions }
...
encodeAddLabelInput (AddLabelInput input____) =
    Encode.maybeObject
        [ ( "rootnameid", Encode.string input____.rootnameid |> Just ), ( "name", Encode.string input____.name |> Just ), ( "nodes", (encodeNodeRef |> Encode.list) |> Encode.optional input____.nodes ), ( "description", Encode.string |> Encode.optional input____.description ), ( "color", Encode.string |> Encode.optional input____.color ), ( "tensions", (encodeTensionRef |> Encode.list) |> Encode.optional input____.tensions ) ]
...
type alias AddNodeFragmentInputOptionalFields =
    ...
    , visibility : OptionalArgument Schema.Enum.NodeVisibility.NodeVisibility
    , mode : OptionalArgument Schema.Enum.NodeMode.NodeMode
    , type_ : OptionalArgument Schema.Enum.NodeType.NodeType
...
encodeAddNodeFragmentInput input____ =
    Encode.maybeObject
        [ ( "nameid", Encode.string |> Encode.optional input____.nameid ), ( "name", Encode.string |> Encode.optional input____.name ), ( "about", Encode.string |> Encode.optional input____.about ), ( "mandate", encodeMandateRef |> Encode.optional input____.mandate ), ( "skills", (Encode.string |> Encode.list) |> Encode.optional input____.skills ), ( "visibility", Encode.enum Schema.Enum.NodeVisibility.toString |> Encode.optional input____.visibility ), ( "mode", Encode.enum Schema.Enum.NodeMode.toString |> Encode.optional input____.mode ), ( "type_", Encode.enum Schema.Enum.NodeType.toString |> Encode.optional input____.type_ ), ( "first_link", Encode.string |> Encode.optional input____.first_link ), ( "role_ext", Encode.string |> Encode.optional input____.role_ext ), ( "role_type", Encode.enum Schema.Enum.RoleType.toString |> Encode.optional input____.role_type ), ( "color", Encode.string |> Encode.optional input____.color ) ]
...
type alias AddNodeInputRequiredFields =
    ...
    , name : String
    , isRoot : Bool
    , type_ : Schema.Enum.NodeType.NodeType
    , visibility : Schema.Enum.NodeVisibility.NodeVisibility
    , mode : Schema.Enum.NodeMode.NodeMode
    , rights : Int
    , isArchived : Bool
    }
...
type alias AddNodeInputOptionalFields =
    ...
    , lexicon : OptionalArgument String
    , isTemplateTensionOnly : OptionalArgument Bool
    , isPinnedTensionfetchRecursively : OptionalArgument Bool
    ...
    , activity : OptionalArgument (List ActivityRef)
    , avatar : OptionalArgument FileRef
    , cascade_directive : OptionalArgument Bool
    }
...
buildAddPendingUserInput required____ fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { updatedAt = Absent, password = Absent, email_token = Absent, token = Absent, contracts = Absent, subscribe = Absent, lang = Absent }
    in
    AddPendingUserInput { updatedAt = optionals____.updatedAt, username = required____.username, password = optionals____.password, email = required____.email, email_token = optionals____.email_token, token = optionals____.token, contracts = optionals____.contracts, subscribe = optionals____.subscribe, lang = optionals____.lang }
...
type alias AddPendingUserInputOptionalFields =
    ...
    , lang : OptionalArgument Schema.Enum.Lang.Lang
    }
...
encodeAddPendingUserInput (AddPendingUserInput input____) =
    Encode.maybeObject
        [ ( "updatedAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.updatedAt ), ( "username", Encode.string input____.username |> Just ), ( "password", Encode.string |> Encode.optional input____.password ), ( "email", Encode.string input____.email |> Just ), ( "email_token", Encode.string |> Encode.optional input____.email_token ), ( "token", Encode.string |> Encode.optional input____.token ), ( "contracts", (encodeContractRef |> Encode.list) |> Encode.optional input____.contracts ), ( "subscribe", Encode.bool |> Encode.optional input____.subscribe ), ( "lang", Encode.enum Schema.Enum.Lang.toString |> Encode.optional input____.lang ) ]
...
buildAddProjectColumnInput required____ fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { description = Absent, color = Absent, cards = Absent, tensions = Absent, drafts = Absent }
    in
    AddProjectColumnInput { name = required____.name, description = optionals____.description, color = optionals____.color, pos = required____.pos, col_type = required____.col_type, cards = optionals____.cards, project = required____.project, tensions = optionals____.tensions, drafts = optionals____.drafts }


type alias AddProjectColumnInputRequiredFields =
    { name : String
    , pos : Int
    , col_type : Schema.Enum.ProjectColumnType.ProjectColumnType
    , project : ProjectRef
    }
...
type alias AddProjectColumnInputOptionalFields =
    ...
    , tensions : OptionalArgument (List TensionRef)
    , drafts : OptionalArgument (List ProjectDraftRef)
    }
...
encodeAddProjectColumnInput (AddProjectColumnInput input____) =
    Encode.maybeObject
        [ ( "name", Encode.string input____.name |> Just ), ( "description", Encode.string |> Encode.optional input____.description ), ( "color", Encode.string |> Encode.optional input____.color ), ( "pos", Encode.int input____.pos |> Just ), ( "col_type", Encode.enum Schema.Enum.ProjectColumnType.toString input____.col_type |> Just ), ( "cards", (encodeProjectCardRef |> Encode.list) |> Encode.optional input____.cards ), ( "project", encodeProjectRef input____.project |> Just ), ( "tensions", (encodeTensionRef |> Encode.list) |> Encode.optional input____.tensions ), ( "drafts", (encodeProjectDraftRef |> Encode.list) |> Encode.optional input____.drafts ) ]
...
type alias AddProjectFieldInputRequiredFields =
    { field_type : Schema.Enum.ProjectFieldType.ProjectFieldType
    , isVisible : Bool
    }
...
encodeAddProjectFieldInput (AddProjectFieldInput input____) =
    Encode.maybeObject
        [ ( "field_type", Encode.enum Schema.Enum.ProjectFieldType.toString input____.field_type |> Just ), ( "isVisible", Encode.bool input____.isVisible |> Just ), ( "values", (encodeProjectFieldValueRef |> Encode.list) |> Encode.optional input____.values ) ]
...
type alias AddProjectInputRequiredFields =
    { createdBy : UserRef
    , createdAt : Schema.ScalarCodecs.DateTime
    , updatedAt : Schema.ScalarCodecs.DateTime
    , rootnameid : String
    , parentnameid : String
    , nameid : String
    , name : String
    , status : Schema.Enum.ProjectStatus.ProjectStatus
...
buildAddRoleExtInput required____ fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { nodes = Absent, about = Absent, color = Absent, mandate = Absent, roles = Absent }
    in
    AddRoleExtInput { rootnameid = required____.rootnameid, name = required____.name, nodes = optionals____.nodes, about = optionals____.about, role_type = required____.role_type, color = optionals____.color, mandate = optionals____.mandate, roles = optionals____.roles }


type alias AddRoleExtInputRequiredFields =
    { rootnameid : String
    , name : String
    , role_type : Schema.Enum.RoleType.RoleType
    }
...
encodeAddRoleExtInput (AddRoleExtInput input____) =
    Encode.maybeObject
        [ ( "rootnameid", Encode.string input____.rootnameid |> Just ), ( "name", Encode.string input____.name |> Just ), ( "nodes", (encodeNodeRef |> Encode.list) |> Encode.optional input____.nodes ), ( "about", Encode.string |> Encode.optional input____.about ), ( "role_type", Encode.enum Schema.Enum.RoleType.toString input____.role_type |> Just ), ( "color", Encode.string |> Encode.optional input____.color ), ( "mandate", encodeMandateRef |> Encode.optional input____.mandate ), ( "roles", (encodeNodeRef |> Encode.list) |> Encode.optional input____.roles ) ]
...
buildAddTensionTemplateInput :
    AddTensionTemplateInputRequiredFields
    -> (AddTensionTemplateInputOptionalFields -> AddTensionTemplateInputOptionalFields)
    -> AddTensionTemplateInput
buildAddTensionTemplateInput required____ fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
...
{-| Type alias for the `AddTensionTemplateInput` attributes. Note that this type
needs to use the `AddTensionTemplateInput` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/elm-graphql/issues/33>.
-}
...
{-| Type for the AddTensionTemplateInput input object.
-}
type AddTensionTemplateInput
    = AddTensionTemplateInput AddTensionTemplateInputRaw


{-| Encode a AddTensionTemplateInput into a value that can be used as an argument.
-}
...
encodeAddUserEventInput (AddUserEventInput input____) =
    Encode.maybeObject
        [ ( "createdAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) input____.createdAt |> Just ), ( "isRead", Encode.bool input____.isRead |> Just ), ( "user", encodeUserRef input____.user |> Just ), ( "event", (encodeEventKindRef |> Encode.list) |> Encode.optional input____.event ) ]
...
type alias AddUserRightsInputRequiredFields =
    { type_ : Schema.Enum.UserType.UserType
    , canLogin : Bool
    , canCreateRoot : Bool
    , maxPublicOrga : Int
    , maxPrivateOrga : Int
...
buildBlobFilter fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { id = Absent, createdAt = Absent, message = Absent, pushedFlag = Absent, has = Absent, and = Absent, or = Absent, not = Absent }
    in
    BlobFilter { id = optionals____.id, createdAt = optionals____.createdAt, message = optionals____.message, pushedFlag = optionals____.pushedFlag, has = optionals____.has, and = optionals____.and, or = optionals____.or, not = optionals____.not }
...
type alias BlobFilterOptionalFields =
    ...
    , has : OptionalArgument (List (Maybe Schema.Enum.BlobHasFilter.BlobHasFilter))
...
encodeBlobFilter (BlobFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "createdAt", encodeDateTimeFilter |> Encode.optional input____.createdAt ), ( "message", encodeStringFullTextFilter |> Encode.optional input____.message ), ( "pushedFlag", encodeDateTimeFilter |> Encode.optional input____.pushedFlag ), ( "has", (Encode.enum Schema.Enum.BlobHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeBlobFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeBlobFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeBlobFilter |> Encode.optional input____.not ) ]
...
type alias BlobOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.BlobOrderable.BlobOrderable
    , desc : OptionalArgument Schema.Enum.BlobOrderable.BlobOrderable
...
encodeBlobOrder (BlobOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.BlobOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.BlobOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeBlobOrder |> Encode.optional input____.then_ ) ]
...
buildBlobPatch fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { createdBy = Absent, createdAt = Absent, updatedAt = Absent, message = Absent, tension = Absent, pushedFlag = Absent, node = Absent }
    in
    BlobPatch { createdBy = optionals____.createdBy, createdAt = optionals____.createdAt, updatedAt = optionals____.updatedAt, message = optionals____.message, tension = optionals____.tension, pushedFlag = optionals____.pushedFlag, node = optionals____.node }


type alias BlobPatchOptionalFields =
    { createdBy : OptionalArgument UserRef
    , createdAt : OptionalArgument Schema.ScalarCodecs.DateTime
    , updatedAt : OptionalArgument Schema.ScalarCodecs.DateTime
    , message : OptionalArgument String
    , tension : OptionalArgument TensionRef
    , pushedFlag : OptionalArgument Schema.ScalarCodecs.DateTime
...
buildBlobRef fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { id = Absent, createdBy = Absent, createdAt = Absent, updatedAt = Absent, message = Absent, tension = Absent, pushedFlag = Absent, node = Absent }
    in
    BlobRef { id = optionals____.id, createdBy = optionals____.createdBy, createdAt = optionals____.createdAt, updatedAt = optionals____.updatedAt, message = optionals____.message, tension = optionals____.tension, pushedFlag = optionals____.pushedFlag, node = optionals____.node }
...
type alias BuildInfoFilterOptionalFields =
    { has : OptionalArgument (List (Maybe Schema.Enum.BuildInfoHasFilter.BuildInfoHasFilter))
...
type alias BuildInfoOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.BuildInfoOrderable.BuildInfoOrderable
    , desc : OptionalArgument Schema.Enum.BuildInfoOrderable.BuildInfoOrderable
...
encodeBuildInfoOrder (BuildInfoOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.BuildInfoOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.BuildInfoOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeBuildInfoOrder |> Encode.optional input____.then_ ) ]
...
type alias CardKindFilterOptionalFields =
    { memberTypes : OptionalArgument (List Schema.Enum.CardKindType.CardKindType)
...
encodeCardKindFilter (CardKindFilter input____) =
    Encode.maybeObject
        [ ( "memberTypes", (Encode.enum Schema.Enum.CardKindType.toString |> Encode.list) |> Encode.optional input____.memberTypes ), ( "tensionFilter", encodeTensionFilter |> Encode.optional input____.tensionFilter ), ( "projectDraftFilter", encodeProjectDraftFilter |> Encode.optional input____.projectDraftFilter ) ]
...
type alias CommentFilterOptionalFields =
    ...
    , createdAt : OptionalArgument DateTimeFilter
    , message : OptionalArgument StringFullTextFilter
    , has : OptionalArgument (List (Maybe Schema.Enum.CommentHasFilter.CommentHasFilter))
...
encodeCommentFilter (CommentFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "createdAt", encodeDateTimeFilter |> Encode.optional input____.createdAt ), ( "message", encodeStringFullTextFilter |> Encode.optional input____.message ), ( "has", (Encode.enum Schema.Enum.CommentHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeCommentFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeCommentFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeCommentFilter |> Encode.optional input____.not ) ]
...
type alias CommentOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.CommentOrderable.CommentOrderable
    , desc : OptionalArgument Schema.Enum.CommentOrderable.CommentOrderable
...
encodeCommentOrder (CommentOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.CommentOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.CommentOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeCommentOrder |> Encode.optional input____.then_ ) ]
...
type alias ContractFilterOptionalFields =
    ...
    , has : OptionalArgument (List (Maybe Schema.Enum.ContractHasFilter.ContractHasFilter))
...
encodeContractFilter (ContractFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "createdAt", encodeDateTimeFilter |> Encode.optional input____.createdAt ), ( "message", encodeStringFullTextFilter |> Encode.optional input____.message ), ( "contractid", encodeStringHashFilter |> Encode.optional input____.contractid ), ( "status", encodeContractStatus_hash |> Encode.optional input____.status ), ( "contract_type", encodeContractType_hash |> Encode.optional input____.contract_type ), ( "closedAt", encodeDateTimeFilter |> Encode.optional input____.closedAt ), ( "has", (Encode.enum Schema.Enum.ContractHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeContractFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeContractFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeContractFilter |> Encode.optional input____.not ) ]
...
type alias ContractOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.ContractOrderable.ContractOrderable
    , desc : OptionalArgument Schema.Enum.ContractOrderable.ContractOrderable
...
encodeContractOrder (ContractOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.ContractOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.ContractOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeContractOrder |> Encode.optional input____.then_ ) ]
...
type alias ContractPatchOptionalFields =
    ...
    , message : OptionalArgument String
    , tension : OptionalArgument TensionRef
    , status : OptionalArgument Schema.Enum.ContractStatus.ContractStatus
    , contract_type : OptionalArgument Schema.Enum.ContractType.ContractType
    , closedAt : OptionalArgument Schema.ScalarCodecs.DateTime
...
encodeContractPatch (ContractPatch input____) =
    Encode.maybeObject
        [ ( "createdBy", encodeUserRef |> Encode.optional input____.createdBy ), ( "createdAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.createdAt ), ( "updatedAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.updatedAt ), ( "message", Encode.string |> Encode.optional input____.message ), ( "tension", encodeTensionRef |> Encode.optional input____.tension ), ( "status", Encode.enum Schema.Enum.ContractStatus.toString |> Encode.optional input____.status ), ( "contract_type", Encode.enum Schema.Enum.ContractType.toString |> Encode.optional input____.contract_type ), ( "closedAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.closedAt ), ( "event", encodeEventFragmentRef |> Encode.optional input____.event ), ( "participants", (encodeVoteRef |> Encode.list) |> Encode.optional input____.participants ), ( "candidates", (encodeUserRef |> Encode.list) |> Encode.optional input____.candidates ), ( "pending_candidates", (encodePendingUserRef |> Encode.list) |> Encode.optional input____.pending_candidates ), ( "comments", (encodeCommentRef |> Encode.list) |> Encode.optional input____.comments ), ( "isValidator", Encode.bool |> Encode.optional input____.isValidator ) ]
...
encodeContractRef (ContractRef input____) =
    Encode.maybeObject
        [ ( "id", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.id ), ( "createdBy", encodeUserRef |> Encode.optional input____.createdBy ), ( "createdAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.createdAt ), ( "updatedAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.updatedAt ), ( "message", Encode.string |> Encode.optional input____.message ), ( "contractid", Encode.string |> Encode.optional input____.contractid ), ( "tension", encodeTensionRef |> Encode.optional input____.tension ), ( "status", Encode.enum Schema.Enum.ContractStatus.toString |> Encode.optional input____.status ), ( "contract_type", Encode.enum Schema.Enum.ContractType.toString |> Encode.optional input____.contract_type ), ( "closedAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.closedAt ), ( "event", encodeEventFragmentRef |> Encode.optional input____.event ), ( "participants", (encodeVoteRef |> Encode.list) |> Encode.optional input____.participants ), ( "candidates", (encodeUserRef |> Encode.list) |> Encode.optional input____.candidates ), ( "pending_candidates", (encodePendingUserRef |> Encode.list) |> Encode.optional input____.pending_candidates ), ( "comments", (encodeCommentRef |> Encode.list) |> Encode.optional input____.comments ), ( "isValidator", Encode.bool |> Encode.optional input____.isValidator ) ]
...
type alias ContractStatus_hashOptionalFields =
    { eq : OptionalArgument Schema.Enum.ContractStatus.ContractStatus
    , in_ : OptionalArgument (List (Maybe Schema.Enum.ContractStatus.ContractStatus))
    }
...
encodeContractStatus_hash input____ =
    Encode.maybeObject
        [ ( "eq", Encode.enum Schema.Enum.ContractStatus.toString |> Encode.optional input____.eq ), ( "in", (Encode.enum Schema.Enum.ContractStatus.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.in_ ) ]
...
type alias ContractType_hashOptionalFields =
    { eq : OptionalArgument Schema.Enum.ContractType.ContractType
    , in_ : OptionalArgument (List (Maybe Schema.Enum.ContractType.ContractType))
    }
...
encodeContractType_hash input____ =
    Encode.maybeObject
        [ ( "eq", Encode.enum Schema.Enum.ContractType.toString |> Encode.optional input____.eq ), ( "in", (Encode.enum Schema.Enum.ContractType.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.in_ ) ]
...
type alias CustomHTTPRequiredFields =
    { url : String
    , method : Schema.Enum.HTTPMethod.HTTPMethod
    }
...
type alias CustomHTTPOptionalFields =
    ...
    , mode : OptionalArgument Schema.Enum.Mode.Mode
...
encodeCustomHTTP input____ =
    Encode.maybeObject
        [ ( "url", Encode.string input____.url |> Just ), ( "method", Encode.enum Schema.Enum.HTTPMethod.toString input____.method |> Just ), ( "body", Encode.string |> Encode.optional input____.body ), ( "graphql", Encode.string |> Encode.optional input____.graphql ), ( "mode", Encode.enum Schema.Enum.Mode.toString |> Encode.optional input____.mode ), ( "forwardHeaders", (Encode.string |> Encode.list) |> Encode.optional input____.forwardHeaders ), ( "secretHeaders", (Encode.string |> Encode.list) |> Encode.optional input____.secretHeaders ), ( "introspectionHeaders", (Encode.string |> Encode.list) |> Encode.optional input____.introspectionHeaders ), ( "skipIntrospection", Encode.bool |> Encode.optional input____.skipIntrospection ) ]
...
type alias DateTimeFilterOptionalFields =
    { eq : OptionalArgument Schema.ScalarCodecs.DateTime
    , in_ : OptionalArgument (List (Maybe Schema.ScalarCodecs.DateTime))
    , le : OptionalArgument Schema.ScalarCodecs.DateTime
    , lt : OptionalArgument Schema.ScalarCodecs.DateTime
    , ge : OptionalArgument Schema.ScalarCodecs.DateTime
    , gt : OptionalArgument Schema.ScalarCodecs.DateTime
...
encodeDateTimeFilter input____ =
    Encode.maybeObject
        [ ( "eq", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.eq ), ( "in", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.maybe |> Encode.list) |> Encode.optional input____.in_ ), ( "le", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.le ), ( "lt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.lt ), ( "ge", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.ge ), ( "gt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.gt ), ( "between", encodeDateTimeRange |> Encode.optional input____.between ) ]
...
type alias DateTimeRangeRequiredFields =
    { min : Schema.ScalarCodecs.DateTime
    , max : Schema.ScalarCodecs.DateTime
    }
...
encodeDateTimeRange input____ =
    Encode.maybeObject
        [ ( "min", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) input____.min |> Just ), ( "max", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) input____.max |> Just ) ]
...
type alias EventCountFilterOptionalFields =
    { has : OptionalArgument (List (Maybe Schema.Enum.EventCountHasFilter.EventCountHasFilter))
...
encodeEventCountFilter (EventCountFilter input____) =
    Encode.maybeObject
        [ ( "has", (Encode.enum Schema.Enum.EventCountHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeEventCountFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeEventCountFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeEventCountFilter |> Encode.optional input____.not ) ]
...
type alias EventCountOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.EventCountOrderable.EventCountOrderable
    , desc : OptionalArgument Schema.Enum.EventCountOrderable.EventCountOrderable
...
encodeEventCountOrder (EventCountOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.EventCountOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.EventCountOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeEventCountOrder |> Encode.optional input____.then_ ) ]
...
type alias EventFilterOptionalFields =
    ...
    , has : OptionalArgument (List (Maybe Schema.Enum.EventHasFilter.EventHasFilter))
...
encodeEventFilter (EventFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "createdAt", encodeDateTimeFilter |> Encode.optional input____.createdAt ), ( "message", encodeStringFullTextFilter |> Encode.optional input____.message ), ( "event_type", encodeTensionEvent_hash |> Encode.optional input____.event_type ), ( "has", (Encode.enum Schema.Enum.EventHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeEventFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeEventFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeEventFilter |> Encode.optional input____.not ) ]
...
type alias EventFragmentFilterOptionalFields =
    { event_type : OptionalArgument TensionEvent_hash
    , has : OptionalArgument (List (Maybe Schema.Enum.EventFragmentHasFilter.EventFragmentHasFilter))
...
encodeEventFragmentFilter (EventFragmentFilter input____) =
    Encode.maybeObject
        [ ( "event_type", encodeTensionEvent_hash |> Encode.optional input____.event_type ), ( "has", (Encode.enum Schema.Enum.EventFragmentHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeEventFragmentFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeEventFragmentFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeEventFragmentFilter |> Encode.optional input____.not ) ]
...
type alias EventFragmentOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.EventFragmentOrderable.EventFragmentOrderable
    , desc : OptionalArgument Schema.Enum.EventFragmentOrderable.EventFragmentOrderable
...
encodeEventFragmentOrder (EventFragmentOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.EventFragmentOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.EventFragmentOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeEventFragmentOrder |> Encode.optional input____.then_ ) ]
...
type alias EventFragmentPatchOptionalFields =
    { event_type : OptionalArgument Schema.Enum.TensionEvent.TensionEvent
    , old : OptionalArgument String
    , new : OptionalArgument String
    }
...
encodeEventFragmentPatch input____ =
    Encode.maybeObject
        [ ( "event_type", Encode.enum Schema.Enum.TensionEvent.toString |> Encode.optional input____.event_type ), ( "old", Encode.string |> Encode.optional input____.old ), ( "new", Encode.string |> Encode.optional input____.new ) ]
...
type alias EventKindFilterOptionalFields =
    { memberTypes : OptionalArgument (List Schema.Enum.EventKindType.EventKindType)
...
encodeEventKindFilter (EventKindFilter input____) =
    Encode.maybeObject
        [ ( "memberTypes", (Encode.enum Schema.Enum.EventKindType.toString |> Encode.list) |> Encode.optional input____.memberTypes ), ( "eventFilter", encodeEventFilter |> Encode.optional input____.eventFilter ), ( "contractFilter", encodeContractFilter |> Encode.optional input____.contractFilter ), ( "notifFilter", encodeNotifFilter |> Encode.optional input____.notifFilter ) ]
...
type alias EventOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.EventOrderable.EventOrderable
    , desc : OptionalArgument Schema.Enum.EventOrderable.EventOrderable
...
encodeEventOrder (EventOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.EventOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.EventOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeEventOrder |> Encode.optional input____.then_ ) ]
...
encodeEventPatch (EventPatch input____) =
    Encode.maybeObject
        [ ( "createdBy", encodeUserRef |> Encode.optional input____.createdBy ), ( "createdAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.createdAt ), ( "updatedAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.updatedAt ), ( "message", Encode.string |> Encode.optional input____.message ), ( "tension", encodeTensionRef |> Encode.optional input____.tension ), ( "event_type", Encode.enum Schema.Enum.TensionEvent.toString |> Encode.optional input____.event_type ), ( "mentioned", encodeTensionRef |> Encode.optional input____.mentioned ), ( "old", Encode.string |> Encode.optional input____.old ), ( "new", Encode.string |> Encode.optional input____.new ) ]
...
buildFileFilter fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { id = Absent, createdAt = Absent, storageKey = Absent, has = Absent, and = Absent, or = Absent, not = Absent }
    in
    FileFilter { id = optionals____.id, createdAt = optionals____.createdAt, storageKey = optionals____.storageKey, has = optionals____.has, and = optionals____.and, or = optionals____.or, not = optionals____.not }


type alias FileFilterOptionalFields =
    { id : OptionalArgument (List Schema.ScalarCodecs.Id)
    , createdAt : OptionalArgument DateTimeFilter
    , storageKey : OptionalArgument StringHashFilter
    , has : OptionalArgument (List (Maybe Schema.Enum.FileHasFilter.FileHasFilter))
    , and : OptionalArgument (List (Maybe FileFilter))
    , or : OptionalArgument (List (Maybe FileFilter))
    , not : OptionalArgument FileFilter
    }
...
encodeFileFilter (FileFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "createdAt", encodeDateTimeFilter |> Encode.optional input____.createdAt ), ( "storageKey", encodeStringHashFilter |> Encode.optional input____.storageKey ), ( "has", (Encode.enum Schema.Enum.FileHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeFileFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeFileFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeFileFilter |> Encode.optional input____.not ) ]


buildFileOrder :
    (FileOrderOptionalFields -> FileOrderOptionalFields)
    -> FileOrder
buildFileOrder fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { asc = Absent, desc = Absent, then_ = Absent }
    in
    FileOrder { asc = optionals____.asc, desc = optionals____.desc, then_ = optionals____.then_ }


type alias FileOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.FileOrderable.FileOrderable
    , desc : OptionalArgument Schema.Enum.FileOrderable.FileOrderable
    , then_ : OptionalArgument FileOrder
    }


{-| Type alias for the `FileOrder` attributes. Note that this type
needs to use the `FileOrder` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/elm-graphql/issues/33>.
-}
type alias FileOrderRaw =
    { asc : OptionalArgument Schema.Enum.FileOrderable.FileOrderable
    , desc : OptionalArgument Schema.Enum.FileOrderable.FileOrderable
    , then_ : OptionalArgument FileOrder
    }
...
{-| Type for the FileOrder input object.
-}
type FileOrder
    = FileOrder FileOrderRaw


{-| Encode a FileOrder into a value that can be used as an argument.
-}
encodeFileOrder : FileOrder -> Value
encodeFileOrder (FileOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.FileOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.FileOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeFileOrder |> Encode.optional input____.then_ ) ]


buildFilePatch :
    (FilePatchOptionalFields -> FilePatchOptionalFields)
    -> FilePatch
buildFilePatch fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { createdBy = Absent, createdAt = Absent, filename = Absent, contentType = Absent, size = Absent, comment = Absent, tension = Absent, user = Absent, node = Absent, embedded = Absent }
    in
    FilePatch { createdBy = optionals____.createdBy, createdAt = optionals____.createdAt, filename = optionals____.filename, contentType = optionals____.contentType, size = optionals____.size, comment = optionals____.comment, tension = optionals____.tension, user = optionals____.user, node = optionals____.node, embedded = optionals____.embedded }


type alias FilePatchOptionalFields =
    { createdBy : OptionalArgument UserRef
    , createdAt : OptionalArgument Schema.ScalarCodecs.DateTime
...
{-| Type alias for the `FilePatch` attributes. Note that this type
needs to use the `FilePatch` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/elm-graphql/issues/33>.
-}
type alias FilePatchRaw =
    { createdBy : OptionalArgument UserRef
    , createdAt : OptionalArgument Schema.ScalarCodecs.DateTime
    , filename : OptionalArgument String
    , contentType : OptionalArgument String
...
{-| Type for the FilePatch input object.
-}
type FilePatch
    = FilePatch FilePatchRaw


{-| Encode a FilePatch into a value that can be used as an argument.
-}
encodeFilePatch : FilePatch -> Value
encodeFilePatch (FilePatch input____) =
    Encode.maybeObject
        [ ( "createdBy", encodeUserRef |> Encode.optional input____.createdBy ), ( "createdAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.createdAt ), ( "filename", Encode.string |> Encode.optional input____.filename ), ( "contentType", Encode.string |> Encode.optional input____.contentType ), ( "size", Encode.int |> Encode.optional input____.size ), ( "comment", encodeCommentRef |> Encode.optional input____.comment ), ( "tension", encodeTensionRef |> Encode.optional input____.tension ), ( "user", encodeUserRef |> Encode.optional input____.user ), ( "node", encodeNodeRef |> Encode.optional input____.node ), ( "embedded", Encode.bool |> Encode.optional input____.embedded ) ]


buildFileRef :
    (FileRefOptionalFields -> FileRefOptionalFields)
    -> FileRef
buildFileRef fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { id = Absent, createdBy = Absent, createdAt = Absent, filename = Absent, contentType = Absent, size = Absent, storageKey = Absent, comment = Absent, tension = Absent, user = Absent, node = Absent, embedded = Absent }
    in
    FileRef { id = optionals____.id, createdBy = optionals____.createdBy, createdAt = optionals____.createdAt, filename = optionals____.filename, contentType = optionals____.contentType, size = optionals____.size, storageKey = optionals____.storageKey, comment = optionals____.comment, tension = optionals____.tension, user = optionals____.user, node = optionals____.node, embedded = optionals____.embedded }


type alias FileRefOptionalFields =
    { id : OptionalArgument Schema.ScalarCodecs.Id
    , createdBy : OptionalArgument UserRef
    , createdAt : OptionalArgument Schema.ScalarCodecs.DateTime
    , filename : OptionalArgument String
...
{-| Type alias for the `FileRef` attributes. Note that this type
needs to use the `FileRef` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/elm-graphql/issues/33>.
-}
type alias FileRefRaw =
    { id : OptionalArgument Schema.ScalarCodecs.Id
    , createdBy : OptionalArgument UserRef
    , createdAt : OptionalArgument Schema.ScalarCodecs.DateTime
    , filename : OptionalArgument String
...
{-| Type for the FileRef input object.
-}
type FileRef
    = FileRef FileRefRaw


{-| Encode a FileRef into a value that can be used as an argument.
-}
encodeFileRef : FileRef -> Value
encodeFileRef (FileRef input____) =
    Encode.maybeObject
        [ ( "id", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.id ), ( "createdBy", encodeUserRef |> Encode.optional input____.createdBy ), ( "createdAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.createdAt ), ( "filename", Encode.string |> Encode.optional input____.filename ), ( "contentType", Encode.string |> Encode.optional input____.contentType ), ( "size", Encode.int |> Encode.optional input____.size ), ( "storageKey", Encode.string |> Encode.optional input____.storageKey ), ( "comment", encodeCommentRef |> Encode.optional input____.comment ), ( "tension", encodeTensionRef |> Encode.optional input____.tension ), ( "user", encodeUserRef |> Encode.optional input____.user ), ( "node", encodeNodeRef |> Encode.optional input____.node ), ( "embedded", Encode.bool |> Encode.optional input____.embedded ) ]
...
type alias Int64FilterOptionalFields =
    { eq : OptionalArgument Schema.ScalarCodecs.Int64
    , in_ : OptionalArgument (List (Maybe Schema.ScalarCodecs.Int64))
    , le : OptionalArgument Schema.ScalarCodecs.Int64
    , lt : OptionalArgument Schema.ScalarCodecs.Int64
    , ge : OptionalArgument Schema.ScalarCodecs.Int64
    , gt : OptionalArgument Schema.ScalarCodecs.Int64
...
encodeInt64Filter input____ =
    Encode.maybeObject
        [ ( "eq", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecInt64) |> Encode.optional input____.eq ), ( "in", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecInt64) |> Encode.maybe |> Encode.list) |> Encode.optional input____.in_ ), ( "le", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecInt64) |> Encode.optional input____.le ), ( "lt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecInt64) |> Encode.optional input____.lt ), ( "ge", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecInt64) |> Encode.optional input____.ge ), ( "gt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecInt64) |> Encode.optional input____.gt ), ( "between", encodeInt64Range |> Encode.optional input____.between ) ]
...
type alias Int64RangeRequiredFields =
    { min : Schema.ScalarCodecs.Int64
    , max : Schema.ScalarCodecs.Int64
    }
...
encodeInt64Range input____ =
    Encode.maybeObject
        [ ( "min", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecInt64) input____.min |> Just ), ( "max", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecInt64) input____.max |> Just ) ]
...
type alias LabelFilterOptionalFields =
    ...
    , has : OptionalArgument (List (Maybe Schema.Enum.LabelHasFilter.LabelHasFilter))
...
type alias LabelOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.LabelOrderable.LabelOrderable
    , desc : OptionalArgument Schema.Enum.LabelOrderable.LabelOrderable
...
encodeLabelOrder (LabelOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.LabelOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.LabelOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeLabelOrder |> Encode.optional input____.then_ ) ]
...
buildLabelPatch fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { rootnameid = Absent, name = Absent, nodes = Absent, description = Absent, color = Absent, tensions = Absent }
    in
    LabelPatch { rootnameid = optionals____.rootnameid, name = optionals____.name, nodes = optionals____.nodes, description = optionals____.description, color = optionals____.color, tensions = optionals____.tensions }
...
encodeLabelPatch (LabelPatch input____) =
    Encode.maybeObject
        [ ( "rootnameid", Encode.string |> Encode.optional input____.rootnameid ), ( "name", Encode.string |> Encode.optional input____.name ), ( "nodes", (encodeNodeRef |> Encode.list) |> Encode.optional input____.nodes ), ( "description", Encode.string |> Encode.optional input____.description ), ( "color", Encode.string |> Encode.optional input____.color ), ( "tensions", (encodeTensionRef |> Encode.list) |> Encode.optional input____.tensions ) ]
...
buildLabelRef fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { id = Absent, rootnameid = Absent, name = Absent, nodes = Absent, description = Absent, color = Absent, tensions = Absent }
    in
    LabelRef { id = optionals____.id, rootnameid = optionals____.rootnameid, name = optionals____.name, nodes = optionals____.nodes, description = optionals____.description, color = optionals____.color, tensions = optionals____.tensions }
...
encodeLabelRef (LabelRef input____) =
    Encode.maybeObject
        [ ( "id", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.id ), ( "rootnameid", Encode.string |> Encode.optional input____.rootnameid ), ( "name", Encode.string |> Encode.optional input____.name ), ( "nodes", (encodeNodeRef |> Encode.list) |> Encode.optional input____.nodes ), ( "description", Encode.string |> Encode.optional input____.description ), ( "color", Encode.string |> Encode.optional input____.color ), ( "tensions", (encodeTensionRef |> Encode.list) |> Encode.optional input____.tensions ) ]
...
type alias MandateFilterOptionalFields =
    ...
    , has : OptionalArgument (List (Maybe Schema.Enum.MandateHasFilter.MandateHasFilter))
...
encodeMandateFilter (MandateFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "purpose", encodeStringFullTextFilter |> Encode.optional input____.purpose ), ( "has", (Encode.enum Schema.Enum.MandateHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeMandateFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeMandateFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeMandateFilter |> Encode.optional input____.not ) ]
...
type alias MandateOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.MandateOrderable.MandateOrderable
    , desc : OptionalArgument Schema.Enum.MandateOrderable.MandateOrderable
...
encodeMandateOrder (MandateOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.MandateOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.MandateOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeMandateOrder |> Encode.optional input____.then_ ) ]
...
type alias NodeFragmentFilterOptionalFields =
    { id : OptionalArgument (List Schema.ScalarCodecs.Id)
    , has : OptionalArgument (List (Maybe Schema.Enum.NodeFragmentHasFilter.NodeFragmentHasFilter))
...
type alias NodeFragmentOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.NodeFragmentOrderable.NodeFragmentOrderable
    , desc : OptionalArgument Schema.Enum.NodeFragmentOrderable.NodeFragmentOrderable
...
encodeNodeFragmentOrder (NodeFragmentOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.NodeFragmentOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.NodeFragmentOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeNodeFragmentOrder |> Encode.optional input____.then_ ) ]
...
type alias NodeMode_hashOptionalFields =
    { eq : OptionalArgument Schema.Enum.NodeMode.NodeMode
    , in_ : OptionalArgument (List (Maybe Schema.Enum.NodeMode.NodeMode))
    }
...
encodeNodeMode_hash input____ =
    Encode.maybeObject
        [ ( "eq", Encode.enum Schema.Enum.NodeMode.toString |> Encode.optional input____.eq ), ( "in", (Encode.enum Schema.Enum.NodeMode.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.in_ ) ]
...
type alias NodeOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.NodeOrderable.NodeOrderable
    , desc : OptionalArgument Schema.Enum.NodeOrderable.NodeOrderable
...
encodeNodeOrder (NodeOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.NodeOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.NodeOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeNodeOrder |> Encode.optional input____.then_ ) ]
...
type alias NodeType_hashOptionalFields =
    { eq : OptionalArgument Schema.Enum.NodeType.NodeType
    , in_ : OptionalArgument (List (Maybe Schema.Enum.NodeType.NodeType))
    }
...
encodeNodeType_hash input____ =
    Encode.maybeObject
        [ ( "eq", Encode.enum Schema.Enum.NodeType.toString |> Encode.optional input____.eq ), ( "in", (Encode.enum Schema.Enum.NodeType.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.in_ ) ]
...
type alias NodeVisibility_hashOptionalFields =
    { eq : OptionalArgument Schema.Enum.NodeVisibility.NodeVisibility
    , in_ : OptionalArgument (List (Maybe Schema.Enum.NodeVisibility.NodeVisibility))
    }
...
encodeNodeVisibility_hash input____ =
    Encode.maybeObject
        [ ( "eq", Encode.enum Schema.Enum.NodeVisibility.toString |> Encode.optional input____.eq ), ( "in", (Encode.enum Schema.Enum.NodeVisibility.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.in_ ) ]
...
type alias NotifFilterOptionalFields =
    ...
    , createdAt : OptionalArgument DateTimeFilter
    , message : OptionalArgument StringFullTextFilter
    , has : OptionalArgument (List (Maybe Schema.Enum.NotifHasFilter.NotifHasFilter))
...
encodeNotifFilter (NotifFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "createdAt", encodeDateTimeFilter |> Encode.optional input____.createdAt ), ( "message", encodeStringFullTextFilter |> Encode.optional input____.message ), ( "has", (Encode.enum Schema.Enum.NotifHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeNotifFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeNotifFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeNotifFilter |> Encode.optional input____.not ) ]
...
type alias NotifOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.NotifOrderable.NotifOrderable
    , desc : OptionalArgument Schema.Enum.NotifOrderable.NotifOrderable
...
encodeNotifOrder (NotifOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.NotifOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.NotifOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeNotifOrder |> Encode.optional input____.then_ ) ]
...
type alias PendingUserFilterOptionalFields =
    ...
    , has : OptionalArgument (List (Maybe Schema.Enum.PendingUserHasFilter.PendingUserHasFilter))
...
encodePendingUserFilter (PendingUserFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "username", encodeStringHashFilter |> Encode.optional input____.username ), ( "email", encodeStringHashFilter |> Encode.optional input____.email ), ( "email_token", encodeStringHashFilter |> Encode.optional input____.email_token ), ( "token", encodeStringHashFilter |> Encode.optional input____.token ), ( "has", (Encode.enum Schema.Enum.PendingUserHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodePendingUserFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodePendingUserFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodePendingUserFilter |> Encode.optional input____.not ) ]
...
type alias PendingUserOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.PendingUserOrderable.PendingUserOrderable
    , desc : OptionalArgument Schema.Enum.PendingUserOrderable.PendingUserOrderable
...
encodePendingUserOrder (PendingUserOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.PendingUserOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.PendingUserOrderable.toString |> Encode.optional input____.desc ), ( "then", encodePendingUserOrder |> Encode.optional input____.then_ ) ]
    ...
    let
        optionals____ =
            fillOptionals____
                { updatedAt = Absent, password = Absent, email_token = Absent, token = Absent, contracts = Absent, subscribe = Absent, lang = Absent }
    in
    PendingUserPatch { updatedAt = optionals____.updatedAt, password = optionals____.password, email_token = optionals____.email_token, token = optionals____.token, contracts = optionals____.contracts, subscribe = optionals____.subscribe, lang = optionals____.lang }
...
encodePendingUserPatch (PendingUserPatch input____) =
    Encode.maybeObject
        [ ( "updatedAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.updatedAt ), ( "password", Encode.string |> Encode.optional input____.password ), ( "email_token", Encode.string |> Encode.optional input____.email_token ), ( "token", Encode.string |> Encode.optional input____.token ), ( "contracts", (encodeContractRef |> Encode.list) |> Encode.optional input____.contracts ), ( "subscribe", Encode.bool |> Encode.optional input____.subscribe ), ( "lang", Encode.enum Schema.Enum.Lang.toString |> Encode.optional input____.lang ) ]
...
buildPendingUserRef fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { id = Absent, updatedAt = Absent, username = Absent, password = Absent, email = Absent, email_token = Absent, token = Absent, contracts = Absent, subscribe = Absent, lang = Absent }
    in
    PendingUserRef { id = optionals____.id, updatedAt = optionals____.updatedAt, username = optionals____.username, password = optionals____.password, email = optionals____.email, email_token = optionals____.email_token, token = optionals____.token, contracts = optionals____.contracts, subscribe = optionals____.subscribe, lang = optionals____.lang }
...
encodePendingUserRef (PendingUserRef input____) =
    Encode.maybeObject
        [ ( "id", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.id ), ( "updatedAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.updatedAt ), ( "username", Encode.string |> Encode.optional input____.username ), ( "password", Encode.string |> Encode.optional input____.password ), ( "email", Encode.string |> Encode.optional input____.email ), ( "email_token", Encode.string |> Encode.optional input____.email_token ), ( "token", Encode.string |> Encode.optional input____.token ), ( "contracts", (encodeContractRef |> Encode.list) |> Encode.optional input____.contracts ), ( "subscribe", Encode.bool |> Encode.optional input____.subscribe ), ( "lang", Encode.enum Schema.Enum.Lang.toString |> Encode.optional input____.lang ) ]
...
type alias PostFilterOptionalFields =
    ...
    , createdAt : OptionalArgument DateTimeFilter
    , message : OptionalArgument StringFullTextFilter
    , has : OptionalArgument (List (Maybe Schema.Enum.PostHasFilter.PostHasFilter))
...
encodePostFilter (PostFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "createdAt", encodeDateTimeFilter |> Encode.optional input____.createdAt ), ( "message", encodeStringFullTextFilter |> Encode.optional input____.message ), ( "has", (Encode.enum Schema.Enum.PostHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodePostFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodePostFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodePostFilter |> Encode.optional input____.not ) ]
...
type alias PostOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.PostOrderable.PostOrderable
    , desc : OptionalArgument Schema.Enum.PostOrderable.PostOrderable
...
encodePostOrder (PostOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.PostOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.PostOrderable.toString |> Encode.optional input____.desc ), ( "then", encodePostOrder |> Encode.optional input____.then_ ) ]
...
encodePostRef input____ =
    Encode.maybeObject
        [ ( "id", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) input____.id |> Just ) ]
...
type alias ProjectCardFilterOptionalFields =
    { id : OptionalArgument (List Schema.ScalarCodecs.Id)
    , has : OptionalArgument (List (Maybe Schema.Enum.ProjectCardHasFilter.ProjectCardHasFilter))
...
type alias ProjectCardOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.ProjectCardOrderable.ProjectCardOrderable
    , desc : OptionalArgument Schema.Enum.ProjectCardOrderable.ProjectCardOrderable
...
encodeProjectCardOrder (ProjectCardOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.ProjectCardOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.ProjectCardOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeProjectCardOrder |> Encode.optional input____.then_ ) ]
...
encodeProjectCardRef (ProjectCardRef input____) =
    Encode.maybeObject
        [ ( "id", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.id ), ( "pos", Encode.int |> Encode.optional input____.pos ), ( "card", encodeCardKindRef |> Encode.optional input____.card ), ( "pc", encodeProjectColumnRef |> Encode.optional input____.pc ), ( "values", (encodeProjectFieldValueRef |> Encode.list) |> Encode.optional input____.values ) ]
...
type alias ProjectColumnFilterOptionalFields =
    ...
    , has : OptionalArgument (List (Maybe Schema.Enum.ProjectColumnHasFilter.ProjectColumnHasFilter))
...
encodeProjectColumnFilter (ProjectColumnFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "col_type", encodeProjectColumnType_hash |> Encode.optional input____.col_type ), ( "has", (Encode.enum Schema.Enum.ProjectColumnHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeProjectColumnFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeProjectColumnFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeProjectColumnFilter |> Encode.optional input____.not ) ]
...
type alias ProjectColumnOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.ProjectColumnOrderable.ProjectColumnOrderable
    , desc : OptionalArgument Schema.Enum.ProjectColumnOrderable.ProjectColumnOrderable
...
encodeProjectColumnOrder (ProjectColumnOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.ProjectColumnOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.ProjectColumnOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeProjectColumnOrder |> Encode.optional input____.then_ ) ]
...
buildProjectColumnPatch fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { name = Absent, description = Absent, color = Absent, pos = Absent, col_type = Absent, cards = Absent, project = Absent, tensions = Absent, drafts = Absent }
    in
    ProjectColumnPatch { name = optionals____.name, description = optionals____.description, color = optionals____.color, pos = optionals____.pos, col_type = optionals____.col_type, cards = optionals____.cards, project = optionals____.project, tensions = optionals____.tensions, drafts = optionals____.drafts }
...
type alias ProjectColumnPatchOptionalFields =
    ...
    , color : OptionalArgument String
    , pos : OptionalArgument Int
    , col_type : OptionalArgument Schema.Enum.ProjectColumnType.ProjectColumnType
    , cards : OptionalArgument (List ProjectCardRef)
...
encodeProjectColumnPatch (ProjectColumnPatch input____) =
    Encode.maybeObject
        [ ( "name", Encode.string |> Encode.optional input____.name ), ( "description", Encode.string |> Encode.optional input____.description ), ( "color", Encode.string |> Encode.optional input____.color ), ( "pos", Encode.int |> Encode.optional input____.pos ), ( "col_type", Encode.enum Schema.Enum.ProjectColumnType.toString |> Encode.optional input____.col_type ), ( "cards", (encodeProjectCardRef |> Encode.list) |> Encode.optional input____.cards ), ( "project", encodeProjectRef |> Encode.optional input____.project ), ( "tensions", (encodeTensionRef |> Encode.list) |> Encode.optional input____.tensions ), ( "drafts", (encodeProjectDraftRef |> Encode.list) |> Encode.optional input____.drafts ) ]
...
buildProjectColumnRef fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { id = Absent, name = Absent, description = Absent, color = Absent, pos = Absent, col_type = Absent, cards = Absent, project = Absent, tensions = Absent, drafts = Absent }
    in
    ProjectColumnRef { id = optionals____.id, name = optionals____.name, description = optionals____.description, color = optionals____.color, pos = optionals____.pos, col_type = optionals____.col_type, cards = optionals____.cards, project = optionals____.project, tensions = optionals____.tensions, drafts = optionals____.drafts }
...
encodeProjectColumnRef (ProjectColumnRef input____) =
    Encode.maybeObject
        [ ( "id", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.id ), ( "name", Encode.string |> Encode.optional input____.name ), ( "description", Encode.string |> Encode.optional input____.description ), ( "color", Encode.string |> Encode.optional input____.color ), ( "pos", Encode.int |> Encode.optional input____.pos ), ( "col_type", Encode.enum Schema.Enum.ProjectColumnType.toString |> Encode.optional input____.col_type ), ( "cards", (encodeProjectCardRef |> Encode.list) |> Encode.optional input____.cards ), ( "project", encodeProjectRef |> Encode.optional input____.project ), ( "tensions", (encodeTensionRef |> Encode.list) |> Encode.optional input____.tensions ), ( "drafts", (encodeProjectDraftRef |> Encode.list) |> Encode.optional input____.drafts ) ]
...
type alias ProjectColumnType_hashOptionalFields =
    { eq : OptionalArgument Schema.Enum.ProjectColumnType.ProjectColumnType
    , in_ : OptionalArgument (List (Maybe Schema.Enum.ProjectColumnType.ProjectColumnType))
    }
...
encodeProjectColumnType_hash input____ =
    Encode.maybeObject
        [ ( "eq", Encode.enum Schema.Enum.ProjectColumnType.toString |> Encode.optional input____.eq ), ( "in", (Encode.enum Schema.Enum.ProjectColumnType.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.in_ ) ]
...
type alias ProjectDraftFilterOptionalFields =
    ...
    , createdAt : OptionalArgument DateTimeFilter
    , message : OptionalArgument StringFullTextFilter
    , has : OptionalArgument (List (Maybe Schema.Enum.ProjectDraftHasFilter.ProjectDraftHasFilter))
...
encodeProjectDraftFilter (ProjectDraftFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "createdAt", encodeDateTimeFilter |> Encode.optional input____.createdAt ), ( "message", encodeStringFullTextFilter |> Encode.optional input____.message ), ( "has", (Encode.enum Schema.Enum.ProjectDraftHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeProjectDraftFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeProjectDraftFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeProjectDraftFilter |> Encode.optional input____.not ) ]
...
type alias ProjectDraftOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.ProjectDraftOrderable.ProjectDraftOrderable
    , desc : OptionalArgument Schema.Enum.ProjectDraftOrderable.ProjectDraftOrderable
...
encodeProjectDraftOrder (ProjectDraftOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.ProjectDraftOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.ProjectDraftOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeProjectDraftOrder |> Encode.optional input____.then_ ) ]
...
type alias ProjectFieldFilterOptionalFields =
    { has : OptionalArgument (List (Maybe Schema.Enum.ProjectFieldHasFilter.ProjectFieldHasFilter))
...
encodeProjectFieldFilter (ProjectFieldFilter input____) =
    Encode.maybeObject
        [ ( "has", (Encode.enum Schema.Enum.ProjectFieldHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeProjectFieldFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeProjectFieldFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeProjectFieldFilter |> Encode.optional input____.not ) ]
...
type alias ProjectFieldPatchOptionalFields =
    { field_type : OptionalArgument Schema.Enum.ProjectFieldType.ProjectFieldType
...
encodeProjectFieldPatch (ProjectFieldPatch input____) =
    Encode.maybeObject
        [ ( "field_type", Encode.enum Schema.Enum.ProjectFieldType.toString |> Encode.optional input____.field_type ), ( "isVisible", Encode.bool |> Encode.optional input____.isVisible ), ( "values", (encodeProjectFieldValueRef |> Encode.list) |> Encode.optional input____.values ) ]
...
type alias ProjectFieldValueFilterOptionalFields =
    { has : OptionalArgument (List (Maybe Schema.Enum.ProjectFieldValueHasFilter.ProjectFieldValueHasFilter))
...
type alias ProjectFieldValueOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.ProjectFieldValueOrderable.ProjectFieldValueOrderable
    , desc : OptionalArgument Schema.Enum.ProjectFieldValueOrderable.ProjectFieldValueOrderable
...
encodeProjectFieldValueOrder (ProjectFieldValueOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.ProjectFieldValueOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.ProjectFieldValueOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeProjectFieldValueOrder |> Encode.optional input____.then_ ) ]
...
type alias ProjectFilterOptionalFields =
    ...
    , has : OptionalArgument (List (Maybe Schema.Enum.ProjectHasFilter.ProjectHasFilter))
...
encodeProjectFilter (ProjectFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "createdAt", encodeDateTimeFilter |> Encode.optional input____.createdAt ), ( "rootnameid", encodeStringHashFilter |> Encode.optional input____.rootnameid ), ( "parentnameid", encodeStringHashFilter |> Encode.optional input____.parentnameid ), ( "nameid", encodeStringHashFilter |> Encode.optional input____.nameid ), ( "name", encodeStringFullTextFilter |> Encode.optional input____.name ), ( "status", encodeProjectStatus_hash |> Encode.optional input____.status ), ( "has", (Encode.enum Schema.Enum.ProjectHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeProjectFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeProjectFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeProjectFilter |> Encode.optional input____.not ) ]
...
type alias ProjectOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.ProjectOrderable.ProjectOrderable
    , desc : OptionalArgument Schema.Enum.ProjectOrderable.ProjectOrderable
...
encodeProjectOrder (ProjectOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.ProjectOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.ProjectOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeProjectOrder |> Encode.optional input____.then_ ) ]
...
type alias ProjectPatchOptionalFields =
    ...
    , name : OptionalArgument String
    , description : OptionalArgument String
    , status : OptionalArgument Schema.Enum.ProjectStatus.ProjectStatus
    , columns : OptionalArgument (List ProjectColumnRef)
    , fields : OptionalArgument (List ProjectFieldRef)
    , nodes : OptionalArgument (List NodeRef)
    , collaborators : OptionalArgument (List UserRef)
...
encodeProjectPatch (ProjectPatch input____) =
    Encode.maybeObject
        [ ( "createdBy", encodeUserRef |> Encode.optional input____.createdBy ), ( "createdAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.createdAt ), ( "updatedAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.updatedAt ), ( "rootnameid", Encode.string |> Encode.optional input____.rootnameid ), ( "parentnameid", Encode.string |> Encode.optional input____.parentnameid ), ( "nameid", Encode.string |> Encode.optional input____.nameid ), ( "name", Encode.string |> Encode.optional input____.name ), ( "description", Encode.string |> Encode.optional input____.description ), ( "status", Encode.enum Schema.Enum.ProjectStatus.toString |> Encode.optional input____.status ), ( "columns", (encodeProjectColumnRef |> Encode.list) |> Encode.optional input____.columns ), ( "fields", (encodeProjectFieldRef |> Encode.list) |> Encode.optional input____.fields ), ( "nodes", (encodeNodeRef |> Encode.list) |> Encode.optional input____.nodes ), ( "collaborators", (encodeUserRef |> Encode.list) |> Encode.optional input____.collaborators ), ( "peerCanEditProject", Encode.bool |> Encode.optional input____.peerCanEditProject ), ( "guestCanEditProject", Encode.bool |> Encode.optional input____.guestCanEditProject ) ]
...
encodeProjectRef (ProjectRef input____) =
    Encode.maybeObject
        [ ( "id", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.id ), ( "createdBy", encodeUserRef |> Encode.optional input____.createdBy ), ( "createdAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.createdAt ), ( "updatedAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.updatedAt ), ( "rootnameid", Encode.string |> Encode.optional input____.rootnameid ), ( "parentnameid", Encode.string |> Encode.optional input____.parentnameid ), ( "nameid", Encode.string |> Encode.optional input____.nameid ), ( "name", Encode.string |> Encode.optional input____.name ), ( "description", Encode.string |> Encode.optional input____.description ), ( "status", Encode.enum Schema.Enum.ProjectStatus.toString |> Encode.optional input____.status ), ( "columns", (encodeProjectColumnRef |> Encode.list) |> Encode.optional input____.columns ), ( "fields", (encodeProjectFieldRef |> Encode.list) |> Encode.optional input____.fields ), ( "nodes", (encodeNodeRef |> Encode.list) |> Encode.optional input____.nodes ), ( "collaborators", (encodeUserRef |> Encode.list) |> Encode.optional input____.collaborators ), ( "peerCanEditProject", Encode.bool |> Encode.optional input____.peerCanEditProject ), ( "guestCanEditProject", Encode.bool |> Encode.optional input____.guestCanEditProject ) ]
...
type alias ProjectStatus_hashOptionalFields =
    { eq : OptionalArgument Schema.Enum.ProjectStatus.ProjectStatus
    , in_ : OptionalArgument (List (Maybe Schema.Enum.ProjectStatus.ProjectStatus))
    }
...
type alias ReactionFilterOptionalFields =
    ...
    , has : OptionalArgument (List (Maybe Schema.Enum.ReactionHasFilter.ReactionHasFilter))
...
encodeReactionFilter (ReactionFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "reactionid", encodeStringHashFilter |> Encode.optional input____.reactionid ), ( "has", (Encode.enum Schema.Enum.ReactionHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeReactionFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeReactionFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeReactionFilter |> Encode.optional input____.not ) ]
...
type alias ReactionOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.ReactionOrderable.ReactionOrderable
    , desc : OptionalArgument Schema.Enum.ReactionOrderable.ReactionOrderable
...
encodeReactionOrder (ReactionOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.ReactionOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.ReactionOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeReactionOrder |> Encode.optional input____.then_ ) ]
...
encodeReactionRef (ReactionRef input____) =
    Encode.maybeObject
        [ ( "id", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.id ), ( "reactionid", Encode.string |> Encode.optional input____.reactionid ), ( "user", encodeUserRef |> Encode.optional input____.user ), ( "comment", encodeCommentRef |> Encode.optional input____.comment ), ( "type_", Encode.int |> Encode.optional input____.type_ ) ]
...
type alias RoleExtFilterOptionalFields =
    ...
    , rootnameid : OptionalArgument StringHashFilter
    , name : OptionalArgument StringHashFilter_StringTermFilter
    , has : OptionalArgument (List (Maybe Schema.Enum.RoleExtHasFilter.RoleExtHasFilter))
...
encodeRoleExtFilter (RoleExtFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "rootnameid", encodeStringHashFilter |> Encode.optional input____.rootnameid ), ( "name", encodeStringHashFilter_StringTermFilter |> Encode.optional input____.name ), ( "has", (Encode.enum Schema.Enum.RoleExtHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeRoleExtFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeRoleExtFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeRoleExtFilter |> Encode.optional input____.not ) ]
...
type alias RoleExtOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.RoleExtOrderable.RoleExtOrderable
    , desc : OptionalArgument Schema.Enum.RoleExtOrderable.RoleExtOrderable
...
encodeRoleExtOrder (RoleExtOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.RoleExtOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.RoleExtOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeRoleExtOrder |> Encode.optional input____.then_ ) ]
...
buildRoleExtPatch fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { rootnameid = Absent, name = Absent, nodes = Absent, about = Absent, role_type = Absent, color = Absent, mandate = Absent, roles = Absent }
    in
    RoleExtPatch { rootnameid = optionals____.rootnameid, name = optionals____.name, nodes = optionals____.nodes, about = optionals____.about, role_type = optionals____.role_type, color = optionals____.color, mandate = optionals____.mandate, roles = optionals____.roles }
...
encodeRoleExtPatch (RoleExtPatch input____) =
    Encode.maybeObject
        [ ( "rootnameid", Encode.string |> Encode.optional input____.rootnameid ), ( "name", Encode.string |> Encode.optional input____.name ), ( "nodes", (encodeNodeRef |> Encode.list) |> Encode.optional input____.nodes ), ( "about", Encode.string |> Encode.optional input____.about ), ( "role_type", Encode.enum Schema.Enum.RoleType.toString |> Encode.optional input____.role_type ), ( "color", Encode.string |> Encode.optional input____.color ), ( "mandate", encodeMandateRef |> Encode.optional input____.mandate ), ( "roles", (encodeNodeRef |> Encode.list) |> Encode.optional input____.roles ) ]
...
buildRoleExtRef fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { id = Absent, rootnameid = Absent, name = Absent, nodes = Absent, about = Absent, role_type = Absent, color = Absent, mandate = Absent, roles = Absent }
    in
    RoleExtRef { id = optionals____.id, rootnameid = optionals____.rootnameid, name = optionals____.name, nodes = optionals____.nodes, about = optionals____.about, role_type = optionals____.role_type, color = optionals____.color, mandate = optionals____.mandate, roles = optionals____.roles }
...
encodeRoleExtRef (RoleExtRef input____) =
    Encode.maybeObject
        [ ( "id", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.id ), ( "rootnameid", Encode.string |> Encode.optional input____.rootnameid ), ( "name", Encode.string |> Encode.optional input____.name ), ( "nodes", (encodeNodeRef |> Encode.list) |> Encode.optional input____.nodes ), ( "about", Encode.string |> Encode.optional input____.about ), ( "role_type", Encode.enum Schema.Enum.RoleType.toString |> Encode.optional input____.role_type ), ( "color", Encode.string |> Encode.optional input____.color ), ( "mandate", encodeMandateRef |> Encode.optional input____.mandate ), ( "roles", (encodeNodeRef |> Encode.list) |> Encode.optional input____.roles ) ]
...
type alias RoleType_hashOptionalFields =
    { eq : OptionalArgument Schema.Enum.RoleType.RoleType
    , in_ : OptionalArgument (List (Maybe Schema.Enum.RoleType.RoleType))
    }
...
encodeRoleType_hash input____ =
    Encode.maybeObject
        [ ( "eq", Encode.enum Schema.Enum.RoleType.toString |> Encode.optional input____.eq ), ( "in", (Encode.enum Schema.Enum.RoleType.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.in_ ) ]
...
type alias TensionEvent_hashOptionalFields =
    { eq : OptionalArgument Schema.Enum.TensionEvent.TensionEvent
    , in_ : OptionalArgument (List (Maybe Schema.Enum.TensionEvent.TensionEvent))
    }
...
encodeTensionEvent_hash input____ =
    Encode.maybeObject
        [ ( "eq", Encode.enum Schema.Enum.TensionEvent.toString |> Encode.optional input____.eq ), ( "in", (Encode.enum Schema.Enum.TensionEvent.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.in_ ) ]
...
type alias TensionFilterOptionalFields =
    ...
    , has : OptionalArgument (List (Maybe Schema.Enum.TensionHasFilter.TensionHasFilter))
...
type alias TensionOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.TensionOrderable.TensionOrderable
    , desc : OptionalArgument Schema.Enum.TensionOrderable.TensionOrderable
...
encodeTensionOrder (TensionOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.TensionOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.TensionOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeTensionOrder |> Encode.optional input____.then_ ) ]
...
type alias TensionStatus_hashOptionalFields =
    { eq : OptionalArgument Schema.Enum.TensionStatus.TensionStatus
    , in_ : OptionalArgument (List (Maybe Schema.Enum.TensionStatus.TensionStatus))
    }
...
encodeTensionStatus_hash input____ =
    Encode.maybeObject
        [ ( "eq", Encode.enum Schema.Enum.TensionStatus.toString |> Encode.optional input____.eq ), ( "in", (Encode.enum Schema.Enum.TensionStatus.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.in_ ) ]


buildTensionTemplateFilter :
    (TensionTemplateFilterOptionalFields -> TensionTemplateFilterOptionalFields)
    -> TensionTemplateFilter
buildTensionTemplateFilter fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { id = Absent, rootnameid = Absent, name = Absent, has = Absent, and = Absent, or = Absent, not = Absent }
...
type alias TensionTemplateFilterOptionalFields =
    ...
    , rootnameid : OptionalArgument StringHashFilter
    , name : OptionalArgument StringHashFilter_StringTermFilter
    , has : OptionalArgument (List (Maybe Schema.Enum.TensionTemplateHasFilter.TensionTemplateHasFilter))
    , and : OptionalArgument (List (Maybe TensionTemplateFilter))
    , or : OptionalArgument (List (Maybe TensionTemplateFilter))
    , not : OptionalArgument TensionTemplateFilter
    }


{-| Type alias for the `TensionTemplateFilter` attributes. Note that this type
needs to use the `TensionTemplateFilter` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/elm-graphql/issues/33>.
-}
...
{-| Type for the TensionTemplateFilter input object.
-}
type TensionTemplateFilter
    = TensionTemplateFilter TensionTemplateFilterRaw


{-| Encode a TensionTemplateFilter into a value that can be used as an argument.
-}
encodeTensionTemplateFilter : TensionTemplateFilter -> Value
encodeTensionTemplateFilter (TensionTemplateFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "rootnameid", encodeStringHashFilter |> Encode.optional input____.rootnameid ), ( "name", encodeStringHashFilter_StringTermFilter |> Encode.optional input____.name ), ( "has", (Encode.enum Schema.Enum.TensionTemplateHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeTensionTemplateFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeTensionTemplateFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeTensionTemplateFilter |> Encode.optional input____.not ) ]


buildTensionTemplateOrder :
    (TensionTemplateOrderOptionalFields -> TensionTemplateOrderOptionalFields)
    -> TensionTemplateOrder
buildTensionTemplateOrder fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { asc = Absent, desc = Absent, then_ = Absent }
    in
    TensionTemplateOrder { asc = optionals____.asc, desc = optionals____.desc, then_ = optionals____.then_ }


type alias TensionTemplateOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.TensionTemplateOrderable.TensionTemplateOrderable
    , desc : OptionalArgument Schema.Enum.TensionTemplateOrderable.TensionTemplateOrderable
    , then_ : OptionalArgument TensionTemplateOrder
    }


{-| Type alias for the `TensionTemplateOrder` attributes. Note that this type
needs to use the `TensionTemplateOrder` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/elm-graphql/issues/33>.
-}
type alias TensionTemplateOrderRaw =
    { asc : OptionalArgument Schema.Enum.TensionTemplateOrderable.TensionTemplateOrderable
    , desc : OptionalArgument Schema.Enum.TensionTemplateOrderable.TensionTemplateOrderable
    , then_ : OptionalArgument TensionTemplateOrder
    }
...
{-| Type for the TensionTemplateOrder input object.
-}
type TensionTemplateOrder
    = TensionTemplateOrder TensionTemplateOrderRaw


{-| Encode a TensionTemplateOrder into a value that can be used as an argument.
-}
encodeTensionTemplateOrder : TensionTemplateOrder -> Value
encodeTensionTemplateOrder (TensionTemplateOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.TensionTemplateOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.TensionTemplateOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeTensionTemplateOrder |> Encode.optional input____.then_ ) ]


buildTensionTemplatePatch :
    (TensionTemplatePatchOptionalFields -> TensionTemplatePatchOptionalFields)
    -> TensionTemplatePatch
buildTensionTemplatePatch fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
...
{-| Type alias for the `TensionTemplatePatch` attributes. Note that this type
needs to use the `TensionTemplatePatch` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/elm-graphql/issues/33>.
-}
...
{-| Type for the TensionTemplatePatch input object.
-}
type TensionTemplatePatch
    = TensionTemplatePatch TensionTemplatePatchRaw


{-| Encode a TensionTemplatePatch into a value that can be used as an argument.
-}
encodeTensionTemplatePatch : TensionTemplatePatch -> Value
encodeTensionTemplatePatch (TensionTemplatePatch input____) =
    Encode.maybeObject
        [ ( "rootnameid", Encode.string |> Encode.optional input____.rootnameid ), ( "name", Encode.string |> Encode.optional input____.name ), ( "description", Encode.string |> Encode.optional input____.description ), ( "nodes", (encodeNodeRef |> Encode.list) |> Encode.optional input____.nodes ), ( "is_recursive", Encode.bool |> Encode.optional input____.is_recursive ), ( "title", Encode.string |> Encode.optional input____.title ), ( "comment", Encode.string |> Encode.optional input____.comment ), ( "type_", Encode.enum Schema.Enum.TensionType.toString |> Encode.optional input____.type_ ), ( "labels", (encodeLabelRef |> Encode.list) |> Encode.optional input____.labels ), ( "assignees", (encodeUserRef |> Encode.list) |> Encode.optional input____.assignees ) ]


buildTensionTemplateRef :
    (TensionTemplateRefOptionalFields -> TensionTemplateRefOptionalFields)
    -> TensionTemplateRef
buildTensionTemplateRef fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
...
{-| Type alias for the `TensionTemplateRef` attributes. Note that this type
needs to use the `TensionTemplateRef` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/elm-graphql/issues/33>.
-}
type alias TensionTemplateRefRaw =
    { id : OptionalArgument Schema.ScalarCodecs.Id
    , rootnameid : OptionalArgument String
    , name : OptionalArgument String
    , description : OptionalArgument String
...
{-| Type for the TensionTemplateRef input object.
-}
type TensionTemplateRef
    = TensionTemplateRef TensionTemplateRefRaw


{-| Encode a TensionTemplateRef into a value that can be used as an argument.
-}
...
type alias TensionType_hashOptionalFields =
    { eq : OptionalArgument Schema.Enum.TensionType.TensionType
    , in_ : OptionalArgument (List (Maybe Schema.Enum.TensionType.TensionType))
    }
...
encodeTensionType_hash input____ =
    Encode.maybeObject
        [ ( "eq", Encode.enum Schema.Enum.TensionType.toString |> Encode.optional input____.eq ), ( "in", (Encode.enum Schema.Enum.TensionType.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.in_ ) ]


buildUpdateActivityInput :
    UpdateActivityInputRequiredFields
    -> (UpdateActivityInputOptionalFields -> UpdateActivityInputOptionalFields)
    -> UpdateActivityInput
buildUpdateActivityInput required____ fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { set = Absent, remove = Absent }
    in
    UpdateActivityInput { filter = required____.filter, set = optionals____.set, remove = optionals____.remove }


type alias UpdateActivityInputRequiredFields =
    { filter : ActivityFilter }


type alias UpdateActivityInputOptionalFields =
    { set : OptionalArgument ActivityPatch
    , remove : OptionalArgument ActivityPatch
    }


{-| Type alias for the `UpdateActivityInput` attributes. Note that this type
needs to use the `UpdateActivityInput` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/elm-graphql/issues/33>.
-}
type alias UpdateActivityInputRaw =
    { filter : ActivityFilter
    , set : OptionalArgument ActivityPatch
    , remove : OptionalArgument ActivityPatch
    }
...
{-| Type for the UpdateActivityInput input object.
-}
type UpdateActivityInput
    = UpdateActivityInput UpdateActivityInputRaw


{-| Encode a UpdateActivityInput into a value that can be used as an argument.
-}
encodeUpdateActivityInput : UpdateActivityInput -> Value
encodeUpdateActivityInput (UpdateActivityInput input____) =
    Encode.maybeObject
        [ ( "filter", encodeActivityFilter input____.filter |> Just ), ( "set", encodeActivityPatch |> Encode.optional input____.set ), ( "remove", encodeActivityPatch |> Encode.optional input____.remove ) ]
...
buildUpdateFileInput :
    UpdateFileInputRequiredFields
    -> (UpdateFileInputOptionalFields -> UpdateFileInputOptionalFields)
    -> UpdateFileInput
buildUpdateFileInput required____ fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { set = Absent, remove = Absent }
    in
    UpdateFileInput { filter = required____.filter, set = optionals____.set, remove = optionals____.remove }


type alias UpdateFileInputRequiredFields =
    { filter : FileFilter }


type alias UpdateFileInputOptionalFields =
    { set : OptionalArgument FilePatch
    , remove : OptionalArgument FilePatch
    }


{-| Type alias for the `UpdateFileInput` attributes. Note that this type
needs to use the `UpdateFileInput` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/elm-graphql/issues/33>.
-}
type alias UpdateFileInputRaw =
    { filter : FileFilter
    , set : OptionalArgument FilePatch
    , remove : OptionalArgument FilePatch
    }
...
{-| Type for the UpdateFileInput input object.
-}
type UpdateFileInput
    = UpdateFileInput UpdateFileInputRaw


{-| Encode a UpdateFileInput into a value that can be used as an argument.
-}
encodeUpdateFileInput : UpdateFileInput -> Value
encodeUpdateFileInput (UpdateFileInput input____) =
    Encode.maybeObject
        [ ( "filter", encodeFileFilter input____.filter |> Just ), ( "set", encodeFilePatch |> Encode.optional input____.set ), ( "remove", encodeFilePatch |> Encode.optional input____.remove ) ]
...
buildUpdateTensionTemplateInput :
    UpdateTensionTemplateInputRequiredFields
    -> (UpdateTensionTemplateInputOptionalFields -> UpdateTensionTemplateInputOptionalFields)
    -> UpdateTensionTemplateInput
buildUpdateTensionTemplateInput required____ fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { set = Absent, remove = Absent }
    in
    UpdateTensionTemplateInput { filter = required____.filter, set = optionals____.set, remove = optionals____.remove }


type alias UpdateTensionTemplateInputRequiredFields =
    { filter : TensionTemplateFilter }


type alias UpdateTensionTemplateInputOptionalFields =
    { set : OptionalArgument TensionTemplatePatch
    , remove : OptionalArgument TensionTemplatePatch
    }


{-| Type alias for the `UpdateTensionTemplateInput` attributes. Note that this type
needs to use the `UpdateTensionTemplateInput` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/elm-graphql/issues/33>.
-}
type alias UpdateTensionTemplateInputRaw =
    { filter : TensionTemplateFilter
    , set : OptionalArgument TensionTemplatePatch
    , remove : OptionalArgument TensionTemplatePatch
    }
...
{-| Type for the UpdateTensionTemplateInput input object.
-}
type UpdateTensionTemplateInput
    = UpdateTensionTemplateInput UpdateTensionTemplateInputRaw


{-| Encode a UpdateTensionTemplateInput into a value that can be used as an argument.
-}
encodeUpdateTensionTemplateInput : UpdateTensionTemplateInput -> Value
encodeUpdateTensionTemplateInput (UpdateTensionTemplateInput input____) =
    Encode.maybeObject
        [ ( "filter", encodeTensionTemplateFilter input____.filter |> Just ), ( "set", encodeTensionTemplatePatch |> Encode.optional input____.set ), ( "remove", encodeTensionTemplatePatch |> Encode.optional input____.remove ) ]
...
type alias UserEventFilterOptionalFields =
    ...
    , has : OptionalArgument (List (Maybe Schema.Enum.UserEventHasFilter.UserEventHasFilter))
...
type alias UserEventOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.UserEventOrderable.UserEventOrderable
    , desc : OptionalArgument Schema.Enum.UserEventOrderable.UserEventOrderable
...
encodeUserEventOrder (UserEventOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.UserEventOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.UserEventOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeUserEventOrder |> Encode.optional input____.then_ ) ]
...
encodeUserEventPatch (UserEventPatch input____) =
    Encode.maybeObject
        [ ( "createdAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.createdAt ), ( "isRead", Encode.bool |> Encode.optional input____.isRead ), ( "user", encodeUserRef |> Encode.optional input____.user ), ( "event", (encodeEventKindRef |> Encode.list) |> Encode.optional input____.event ) ]
...
encodeUserEventRef (UserEventRef input____) =
    Encode.maybeObject
        [ ( "id", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.id ), ( "createdAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.createdAt ), ( "isRead", Encode.bool |> Encode.optional input____.isRead ), ( "user", encodeUserRef |> Encode.optional input____.user ), ( "event", (encodeEventKindRef |> Encode.list) |> Encode.optional input____.event ) ]
...
type alias UserFilterOptionalFields =
    ...
    , email : OptionalArgument StringHashFilter
    , has : OptionalArgument (List (Maybe Schema.Enum.UserHasFilter.UserHasFilter))
...
encodeUserFilter (UserFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "username", encodeStringHashFilter_StringRegExpFilter |> Encode.optional input____.username ), ( "name", encodeStringRegExpFilter |> Encode.optional input____.name ), ( "email", encodeStringHashFilter |> Encode.optional input____.email ), ( "has", (Encode.enum Schema.Enum.UserHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeUserFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeUserFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeUserFilter |> Encode.optional input____.not ) ]
...
type alias UserOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.UserOrderable.UserOrderable
    , desc : OptionalArgument Schema.Enum.UserOrderable.UserOrderable
...
encodeUserOrder (UserOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.UserOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.UserOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeUserOrder |> Encode.optional input____.then_ ) ]
...
type alias UserPatchOptionalFields =
    { createdAt : OptionalArgument Schema.ScalarCodecs.DateTime
    , lastAck : OptionalArgument Schema.ScalarCodecs.DateTime
    , name : OptionalArgument String
    , password : OptionalArgument String
    , bio : OptionalArgument String
    , location : OptionalArgument String
...
encodeUserPatch (UserPatch input____) =
    Encode.maybeObject
        [ ( "createdAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.createdAt ), ( "lastAck", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.lastAck ), ( "name", Encode.string |> Encode.optional input____.name ), ( "password", Encode.string |> Encode.optional input____.password ), ( "bio", Encode.string |> Encode.optional input____.bio ), ( "location", Encode.string |> Encode.optional input____.location ), ( "utc", Encode.string |> Encode.optional input____.utc ), ( "links", (Encode.string |> Encode.list) |> Encode.optional input____.links ), ( "skills", (Encode.string |> Encode.list) |> Encode.optional input____.skills ), ( "notifyByEmail", Encode.bool |> Encode.optional input____.notifyByEmail ), ( "lang", Encode.enum Schema.Enum.Lang.toString |> Encode.optional input____.lang ), ( "subscriptions", (encodeTensionRef |> Encode.list) |> Encode.optional input____.subscriptions ), ( "watching", (encodeNodeRef |> Encode.list) |> Encode.optional input____.watching ), ( "rights", encodeUserRightsRef |> Encode.optional input____.rights ), ( "roles", (encodeNodeRef |> Encode.list) |> Encode.optional input____.roles ), ( "tensions_created", (encodeTensionRef |> Encode.list) |> Encode.optional input____.tensions_created ), ( "tensions_assigned", (encodeTensionRef |> Encode.list) |> Encode.optional input____.tensions_assigned ), ( "contracts", (encodeContractRef |> Encode.list) |> Encode.optional input____.contracts ), ( "reactions", (encodeReactionRef |> Encode.list) |> Encode.optional input____.reactions ), ( "events", (encodeUserEventRef |> Encode.list) |> Encode.optional input____.events ), ( "markAllAsRead", Encode.string |> Encode.optional input____.markAllAsRead ), ( "event_count", encodeEventCountRef |> Encode.optional input____.event_count ), ( "activity", (encodeActivityRef |> Encode.list) |> Encode.optional input____.activity ), ( "avatar", encodeFileRef |> Encode.optional input____.avatar ) ]
...
encodeUserRef (UserRef input____) =
    Encode.maybeObject
        [ ( "id", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.optional input____.id ), ( "createdAt", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.createdAt ), ( "lastAck", (Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.lastAck ), ( "username", Encode.string |> Encode.optional input____.username ), ( "name", Encode.string |> Encode.optional input____.name ), ( "email", Encode.string |> Encode.optional input____.email ), ( "password", Encode.string |> Encode.optional input____.password ), ( "bio", Encode.string |> Encode.optional input____.bio ), ( "location", Encode.string |> Encode.optional input____.location ), ( "utc", Encode.string |> Encode.optional input____.utc ), ( "links", (Encode.string |> Encode.list) |> Encode.optional input____.links ), ( "skills", (Encode.string |> Encode.list) |> Encode.optional input____.skills ), ( "notifyByEmail", Encode.bool |> Encode.optional input____.notifyByEmail ), ( "lang", Encode.enum Schema.Enum.Lang.toString |> Encode.optional input____.lang ), ( "subscriptions", (encodeTensionRef |> Encode.list) |> Encode.optional input____.subscriptions ), ( "watching", (encodeNodeRef |> Encode.list) |> Encode.optional input____.watching ), ( "rights", encodeUserRightsRef |> Encode.optional input____.rights ), ( "roles", (encodeNodeRef |> Encode.list) |> Encode.optional input____.roles ), ( "tensions_created", (encodeTensionRef |> Encode.list) |> Encode.optional input____.tensions_created ), ( "tensions_assigned", (encodeTensionRef |> Encode.list) |> Encode.optional input____.tensions_assigned ), ( "contracts", (encodeContractRef |> Encode.list) |> Encode.optional input____.contracts ), ( "reactions", (encodeReactionRef |> Encode.list) |> Encode.optional input____.reactions ), ( "events", (encodeUserEventRef |> Encode.list) |> Encode.optional input____.events ), ( "markAllAsRead", Encode.string |> Encode.optional input____.markAllAsRead ), ( "event_count", encodeEventCountRef |> Encode.optional input____.event_count ), ( "activity", (encodeActivityRef |> Encode.list) |> Encode.optional input____.activity ), ( "avatar", encodeFileRef |> Encode.optional input____.avatar ) ]
...
type alias UserRightsFilterOptionalFields =
    { has : OptionalArgument (List (Maybe Schema.Enum.UserRightsHasFilter.UserRightsHasFilter))
...
encodeUserRightsFilter (UserRightsFilter input____) =
    Encode.maybeObject
        [ ( "has", (Encode.enum Schema.Enum.UserRightsHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeUserRightsFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeUserRightsFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeUserRightsFilter |> Encode.optional input____.not ) ]
...
type alias UserRightsOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.UserRightsOrderable.UserRightsOrderable
    , desc : OptionalArgument Schema.Enum.UserRightsOrderable.UserRightsOrderable
...
encodeUserRightsOrder (UserRightsOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.UserRightsOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.UserRightsOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeUserRightsOrder |> Encode.optional input____.then_ ) ]
...
type alias UserRightsPatchOptionalFields =
    { type_ : OptionalArgument Schema.Enum.UserType.UserType
...
type alias VoteFilterOptionalFields =
    ...
    , has : OptionalArgument (List (Maybe Schema.Enum.VoteHasFilter.VoteHasFilter))
...
encodeVoteFilter (VoteFilter input____) =
    Encode.maybeObject
        [ ( "id", ((Schema.ScalarCodecs.codecs |> Schema.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input____.id ), ( "createdAt", encodeDateTimeFilter |> Encode.optional input____.createdAt ), ( "message", encodeStringFullTextFilter |> Encode.optional input____.message ), ( "voteid", encodeStringHashFilter |> Encode.optional input____.voteid ), ( "has", (Encode.enum Schema.Enum.VoteHasFilter.toString |> Encode.maybe |> Encode.list) |> Encode.optional input____.has ), ( "and", (encodeVoteFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.and ), ( "or", (encodeVoteFilter |> Encode.maybe |> Encode.list) |> Encode.optional input____.or ), ( "not", encodeVoteFilter |> Encode.optional input____.not ) ]
...
type alias VoteOrderOptionalFields =
    { asc : OptionalArgument Schema.Enum.VoteOrderable.VoteOrderable
    , desc : OptionalArgument Schema.Enum.VoteOrderable.VoteOrderable
...
encodeVoteOrder (VoteOrder input____) =
    Encode.maybeObject
        [ ( "asc", Encode.enum Schema.Enum.VoteOrderable.toString |> Encode.optional input____.asc ), ( "desc", Encode.enum Schema.Enum.VoteOrderable.toString |> Encode.optional input____.desc ), ( "then", encodeVoteOrder |> Encode.optional input____.then_ ) ]
