            ...
            [ ul []
                [ li [ classList [ ( "is-active", model.viewMode == ListView ) ] ]
                    [ a [ onClickPD (ChangeViewFilter ListView), target "_blank" ]
                        ...
                        [ div [ title (T.tensionsListTooltip model.session.lexicon) ]
                ...
                --        [ div [ title (T.tensionsIntExtTooltip model.session.lexicon) ]
                ...
                , li [ classList [ ( "is-active", model.viewMode == CircleView ) ] ]
                    [ a [ onClickPD (ChangeViewFilter CircleView), target "_blank" ]
                        ...
                        [ div [ title (T.tensionsCircleTooltip model.session.lexicon) ]
                ...
                , li [ classList [ ( "is-active", model.viewMode == LabelView ) ] ]
                    [ a [ onClickPD (ChangeViewFilter LabelView), target "_blank" ]
                        [ div [ title (T.tensionsLabelTooltip model.session.lexicon) ]
                ...
                , li [ classList [ ( "is-active", model.viewMode == AssigneeView ) ] ]
                    [ a [ onClickPD (ChangeViewFilter AssigneeView), target "_blank" ]
                        --[ a [ onClickPD (GoView CircleView), target "_blank" ]
                        [ div [ title (T.tensionsAssigneeTooltip model.session.lexicon) ]
