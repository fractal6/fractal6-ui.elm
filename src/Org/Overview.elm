...
init global flags =
    let
        ...
        model =
            ...
            , tree_data = ternary fs.orgChange Loading (fromMaybeData session.data.tree_data Loading)
            , tensions_data = ternary fs.orgChange Loading (fromMaybeData session.data.tensions_data Loading)
            , journal_data = NotAsked
            , node_data = ternary fs.orgChange Loading (fromMaybeData session.data.node_data Loading)
            , init_tensions = True
            , init_journal = True
            , init_data = True
